...
<script type="text/javascript" src="/styles/js/jquery.min.js"></script>
 ...
 <jsp:include page="/page/head.jsp"></jsp:include>
        <script type="text/javascript">
            ...
            $(function() {
    			$('input[name=type][type=radio][value=${type}]').attr('checked', true);
    		});
            
            function submitType(value){
            //	alert(value)
              if(value=='田间窝棚'){
            	  window.location="/quzhen/tjwp";
              }else{
            	  window.location="/quzhen/jjlwp";
              }
            }
        </script>
</head>
...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li><a href="#">${date}年田间/经济林窝棚面积统计图</a> <span class="divider"> /</span></li>
  
  </ul>
  <p>类型:<input  type="radio" value="田间窝棚" checked="checked" name="type" onclick="submitType(this.value)"/> 田间窝棚  <input  type="radio" value="经济林窝棚"  name="type" onclick="submitType(this.value)"/> 经济林窝棚 </p>
