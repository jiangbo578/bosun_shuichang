...
<body>
    ...
    <li class="active">新增表</li>
			...
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 社区（家庭）文明建设活动</div>
  <div id="panbody">
	<div class="container">
		<form  action="/wmjianshe/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('社区（家庭）文明建设活动('+myDate.getFullYear()+')');
