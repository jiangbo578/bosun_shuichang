...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 行政村平面图</div>
	  <div id="panbody">
		<div class="container">
		<!-- action="/xzpmt/item/add" -->
				<textarea rows=""  name="enews.contrnt"  id="myEditor" cols="">${editnews.content}</textarea>
			
			<button  class="btn btn-primary" type="button" onclick="javascript:loginfo()" ><i class="icon-ok-sign"></i> 保存</button>
