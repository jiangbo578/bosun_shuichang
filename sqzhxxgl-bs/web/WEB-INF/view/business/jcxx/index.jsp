...
<body>
    ...
    <li /jdbhlx/list/1 class="active">投诉举报咨询台账目录</li>-->
			...
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 基础信息
  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="jcxx:add">
						<a  style="margin-bottom: 5px" href="/jcxx/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="jcxx:update">
											...
											<a class="btn " href="/jcxx/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="jcxx:delete">
											<a class="btn  b_delete_" href="/jcxx/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/jcxx/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="jcxx:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/jcxx/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
