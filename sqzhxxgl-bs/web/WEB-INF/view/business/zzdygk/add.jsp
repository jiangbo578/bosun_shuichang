...
<body>
    ...
    <li ><a href="/zcdygk/list/1">居住在本居民区的在职党员概况名册</a> <span class="divider">/</span></li>
    <li class="active">新增表</li>
  </ul>
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 居住在本居民区的在职党员概况名册</div>
  <div id="panbody">
	<div class="container">
		<form  action="/zzdygk/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('居住在本居民区的在职党员概况名册('+myDate.getFullYear()+')');
