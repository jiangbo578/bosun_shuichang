...
<body>
    ...
    <li class="active">开展星期四爱国卫生义务劳动情况记录表</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i>开展星期四爱国卫生义务劳动情况记录表
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="kzxqsag:add">
						<a  style="margin-bottom: 5px" href="/kzxqsag/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="kzxqsag:update">
											...
											<a class="btn " href="/kzxqsag/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="kzxqsag:delete">
											<a class="btn  b_delete_zcdygk" href="/kzxqsag/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/kzxqsag/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="kzxqsag:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_xfqcwh" href="/kzxqsag/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
