...
<body>
    ...
    <li class="active">新增表</li>
			...
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 公益性社区服务劳动参加对象汇总表</div>
  <div id="panbody">
	<div class="container">
		<form  action="/fwnd/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('公益性社区服务劳动参加对象汇总表('+myDate.getFullYear()+')');
