...
<body>
    ...
    <li class="active">新增表</li>
			...
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 街镇助学结对统计表（个人版）</div>
  <div id="panbody">
	<div class="container">
		<form  action="/zxtjbgrb/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('街镇助学结对统计表（个人版）('+myDate.getFullYear()+')');
