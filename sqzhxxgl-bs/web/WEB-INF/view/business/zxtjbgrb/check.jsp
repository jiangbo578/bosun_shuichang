...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>街镇助学结对统计表（个人版）</strong></div>
  <div id="panbody">
	<div class="container">
		<table class="table  table-bordered ">
			...
			<tbody>
				...
				<tr class="<c:if test="${num.count%2!=0}">even</c:if>">
					...
					<th width="18%">已享受资助金额（元） </th>
					<th width="13%">资助起始年限 </th>
			...
			<tr>
				<th>审核</th>
				<td>
				<form action="/zxtjbgrb/check" method="post">
	...
	<script>
		$(function() {
			...
			var pagination = new buguPagination('${current}',
					'${pages}', '${count}', '/zxtjbgrb/check/', '/${businessFormId }');
