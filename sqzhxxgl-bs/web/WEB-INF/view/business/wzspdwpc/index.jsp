...
<body>
    ...
    <li class="active">无证食品单位季度隐患排查表</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i> 无证食品单位季度隐患排查表
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="wzspdwpc:add">
						<a  style="margin-bottom: 5px" href="/wzspdwpc/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="wzspdwpc:update">
											...
											<a class="btn " href="/wzspdwpc/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="wzspdwpc:delete">
											<a class="btn  b_delete_zcdygk" href="/wzspdwpc/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/wzspdwpc/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="wzspdwpc:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_wzspdwpc" href="/wzspdwpc/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	<script>
		$(function() {
			...
			$('.b_submit_wzspdwpc').on('click', function() {
