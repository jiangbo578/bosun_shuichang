...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
    ...
    <li ><a href="/wzspdwpc/list/1">红十字服务站特困家庭名册</a> <span class="divider">/</span></li>
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<td>
				...
				<tr>
					...
					<c:forEach var="wzsp"  items="${datas}" varStatus="num">
					<tr>
					    <td>${num.count}</td>
						<td>${wzsp.dwmc}</td>
						<td>${wzsp.jydz}</td>
			...
			<tr>
				<th>审核</th>
				<td>
				<form action="/wzspdwpc/check" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function() {
		...
		var pagination = new buguPagination('${current}',
				'${pages}', '${count}', '/wzspdwpc/check/', '/${businessFormId }');
