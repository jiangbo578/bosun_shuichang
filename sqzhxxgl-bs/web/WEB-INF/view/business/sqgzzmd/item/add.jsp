...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 社区工作者名单</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/sqgzzmd/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>住址：</th>
					<td><input name="zz" type="text" id="zz" data-rule="required;"/>
					</td>
				</tr>
				<tr>
					<th>电话：</th>
