...
<body>
    ...
    <li class="active">无证无照经营户</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i> 无证无照经营户
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="wzwzjyh:add">
						<a  style="margin-bottom: 5px" href="/wzwzjyh/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
					...
					<!-- <a href="#" class="tjBtn">提交审核</a> -->
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<td>
									<div class="btn-group">
									<shiro:hasPermission name="wzwzjyh:update">
											
											
											<a class="btn " href="/wzwzjyh/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="wzwzjyh:delete">
											<a class="btn  b_delete_zcdygk" href="/wzwzjyh/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/wzwzjyh/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="wzwzjyh:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_wzwzjyh" href="/wzwzjyh/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	<script>
		$(function() {
			...
			$('.b_submit_wzwzjyh').on('click', function() {
