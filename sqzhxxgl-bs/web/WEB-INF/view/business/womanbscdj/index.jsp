...
<body>
    ...
    <li class="active">退休妇女和生活困难妇女参加妇科病及乳腺病筛查登记表</li><!--
    <li /womanbscdj/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 退休妇女和生活困难妇女参加妇科病及乳腺病筛查登记表
  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="womanbscdj:add">
						<a  style="margin-bottom: 5px" href="/womanbscdj/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="womanbscdj:update">
											...
											<a class="btn " href="/womanbscdj/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="womanbscdj:delete">
											<a class="btn  b_delete_" href="/womanbscdj/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/womanbscdj/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="womanbscdj:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/womanbscdj/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
