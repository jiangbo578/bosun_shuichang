...
<body>
    ...
    <li class="active">新增表</li>
			...
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 退休妇女和生活困难妇女参加妇科病及乳腺病筛查登记表</div>
  <div id="panbody">
	<div class="container">
		<form  action="/womanbscdj/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('退休妇女和生活困难妇女参加妇科病及乳腺病筛查登记表('+myDate.getFullYear()+')');
