			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="jdkhqk:add">
						<a  style="margin-bottom: 5px" href="/jdkhqk/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="jdkhqk:update">
											...
											<a class="btn " href="/jdkhqk/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="jdkhqk:delete">
											<a class="btn  b_delete_zcdygk" href="/jdkhqk/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/jdkhqk/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="jdkhqk:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_xfqcwh" href="/jdkhqk/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
