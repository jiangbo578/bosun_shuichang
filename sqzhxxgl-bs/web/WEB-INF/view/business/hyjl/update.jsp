...
<body>
    ...
    <li ><a href="/hyjl/list/1">红十字应急救护队名册</a> <span class="divider">/</span></li>
    <li class="active">修改表单名称</li>
  </ul>
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>表单名称编辑</strong>红十字应急救护队名册</div>
  <div id="panbody">
	<div class="container">
		<form  action="/hyjl/update" method="post">
