...
<body>
    ...
    <li class="active">学习型社区硬件建设</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 学习型社区硬件建设
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="sqyjjs:add">
						<a  style="margin-bottom: 5px" href="/sqyjjs/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="sqyjjs:update">
											...
											<a class="btn " href="/sqyjjs/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="sqyjjs:delete">
											<a class="btn  b_delete_zcdygk" href="/sqyjjs/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/sqyjjs/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="sqyjjs:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_xfqcwh" href="/sqyjjs/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
