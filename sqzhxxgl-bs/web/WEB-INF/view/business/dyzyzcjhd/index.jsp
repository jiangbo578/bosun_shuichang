...
<body>
    ...
    <li class="active">党员志愿者参与活动情况</li><!--
    <li /dyzyzcjhd/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 党员志愿者参与活动情况
  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="dyzyzcjhd:add">
						<a  style="margin-bottom: 5px" href="/dyzyzcjhd/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="dyzyzcjhd:update">
											...
											<a class="btn " href="/dyzyzcjhd/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="dyzyzcjhd:delete">
											<a class="btn  b_delete_" href="/dyzyzcjhd/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/dyzyzcjhd/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="dyzyzcjhd:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/dyzyzcjhd/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
