...
<body>
    ...
    <li class="active">新增表</li>
			...
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 党员（群众）评议党支部工作情况</div>
  <div id="panbody">
	<div class="container">
		<form  action="/pydzbgz/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('党员（群众）评议党支部工作情况('+myDate.getFullYear()+')');
