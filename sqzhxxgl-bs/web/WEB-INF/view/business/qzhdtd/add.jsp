...
<body>
    ...
    <li class="active">新增表</li>
			...
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 上海市嘉定区社区群众活动团队备案表</div>
  <div id="panbody">
	<div class="container">
		<form  action="/qzhdtd/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('上海市嘉定区社区群众活动团队备案表('+myDate.getFullYear()+')');
