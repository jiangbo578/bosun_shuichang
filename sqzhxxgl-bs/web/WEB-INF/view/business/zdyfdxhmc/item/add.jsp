...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
    ...
    <li><a href="/tsjbzx/list/1">重点优抚对象花名册</a> <span class="divider">/</span></li>
    <li class="active">添加</li>
  </ul>
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 重点优抚对象花名册</div>
  <div id="panbody">
	<div class="container">
		<form action="/zdyfdxhmc/item/add" method="post">
			<table>
				<tr>
					<th>姓名：</th>
				...
				<tr>
					<th>家庭地址：</th>
					<td><input name="jtzz" type="text" id="jtzz" data-rule="required;length[1~30];" />
					</td>
				</tr>
				<tr>
					<th>户籍地址：</th>
