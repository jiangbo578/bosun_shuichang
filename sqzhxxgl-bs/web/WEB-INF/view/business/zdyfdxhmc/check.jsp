...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>重点优抚对象花名册</strong></div>
  <div id="panbody">
	<div class="container">
		<table class="table table-striped table-bordered table-hover">
			...
			<td>
				...
				<tbody>
					<c:forEach items="${datas }" var="tqjrsItem" varStatus="num">
						<tr>
							<td>${num.count }</td>
							<td>${tqjrsItem.xm }</td>
							<td>${tqjrsItem.xb }</td>
							<td><fmt:formatDate pattern='yyyy-MM-dd' value='${tqjrsItem.csny }'/></td>
							<td>${tqjrsItem.idcard }</td>
							<td>${tqjrsItem.whcd }</td>
							<td>${tqjrsItem.jtzz }</td>
			...
			<tr>
				<th>审核</th>
				<td>
				<form action="/zdyfdxhmc/check" method="post">
	...
	<script>
		$(function() {
			...
			var pagination = new buguPagination('${current}',
					'${pages}', '${count}', '/zdyfdxhmc/check/', '/${businessFormId }');
