...
<li><a href="/taizhang/list/3">公共服务</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 无业残疾人名册</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/wycjr/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>残疾证号：</th>
					<td><input name="cjzh" type="text" id="phone" data-rule="required"/>
					</td>
				</tr>	
				<tr>
					<th>是否有就业能力：</th>
