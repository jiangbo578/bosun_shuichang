...
<body>
    ...
    <li ><a href="/cwhcy/list/1">村委会成员名单</a> <span class="divider">/</span></li>
    <li class="active">新增表</li>
  </ul>
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 村会成员名单</div>
  <div id="panbody">
	<div class="container">
		<form  action="/cwhcy/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('村委会成员名单('+myDate.getFullYear()+')');
