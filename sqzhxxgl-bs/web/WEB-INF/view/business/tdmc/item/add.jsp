...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong>团队名册</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/tdmc/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>负责人或党建指导员：</th>
					<td><input name="fzr" type="text" data-rule="required;chinese;length[1~4]" id="fzr"/>
					</td>
				</tr>
				<tr>
					<th>性别：</th>
				...
				<tr>
					<th>队伍名称：</th>
					<td><input name="dwmc" type="text" data-rule="required;chinese" id="dwmc" />
					</td>
				</tr>
						<tr>
					<th>人数：</th>
					<td><input name="rs" type="text" id="rs" data-rule="required;digits;"/>
					</td>
				</tr>
				<tr>
					<th>联系电话：</th>
				...
				<tr>
					...
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" id="clny"  data-rule="required:date;"/>
					</td>
				</tr>
