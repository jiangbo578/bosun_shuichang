...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong>团支部概况及班子成员名单</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/bzcybt/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>团内职务：</th>
					<td><input name="tnzw" type="text" id="tnzw" data-rule="required;"/>
					</td>
				</tr>
				<tr>
					<th>家庭住址：</th>
				...
				<tr>
					<th>单位：</th>
					<td><input name="gzdw" type="text" id="gzdw" data-rule="required;"/>
					</td>
				</tr>
				<tr>
					<th>民族：</th>
					<td><input name="mz" type="text" id="mz" data-rule="required;chinese;length[1~4]"/>
					</td>
				</tr>				
			<tr>
					<th>&nbsp;</th>
