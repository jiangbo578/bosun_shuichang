...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 群众文化团队名单</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/qzwhtd/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>姓名：</th>
					<td><input name="name" type="text" data-rule="required;chinese;length[1~4]" id="name"/>
					</td>
				</tr>
				<tr>
					<th>团队名称：</th>
					<td><input name="tdname" type="text" data-rule="required;chinese" id="dwmc"/>
					</td>
				</tr>
				<tr>
					<th>类型：</th>
				...
				<tr>
					...
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" id="rdny"/>
					</td>
				</tr>
				<tr>
					<th>原单位担任职务：</th>
					<td><input name="ydwrole" type="text" id="ydwrole" data-rule="required;chinese;length[1~4]"/>
					</td>
				</tr>
				<tr>
					<th>团队中职务：</th>
					<td><input name="tdrole" type="text" id="tdrole" data-rule="required;chinese;length[1~4]" />
					</td>
				</tr>
				<tr>
					<th>住址：</th>
					<td><input name="address" type="text" id="address" data-rule="required;length[1~20];" />
					</td>
				</tr>
				<tr>
					<th>联系电话：</th>
				...
				<tr>
					...
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" id="clsj"/>
					</td>
				</tr>
				<tr>
					<th>活动时间：</th>
				...
				<tr>
					<th>活动地点：</th>
					<td><input name="hdaddress" type="text" id="hdaddress"  data-rule="required;length[1~20];" />
					</td>
				</tr>
			<tr>
					<th>&nbsp;</th>
