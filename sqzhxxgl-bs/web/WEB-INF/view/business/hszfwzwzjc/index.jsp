...
<body>
    ...
    <li class="active">红十字服务站会员名册</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i> 红十字服务站物资出借明细
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="hszfwzwzjc:add">
						<a  style="margin-bottom: 5px" href="/hszfwzwzjc/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="hszfwzwzjc:update">
											...
											<a class="btn " href="/hszfwzwzjc/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="hszfwzwzjc:delete">
											<a class="btn  b_delete_zcdygk" href="/hszfwzwzjc/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/hszfwzwzjc/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="hszfwzwzjc:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_xfqcwh" href="/hszfwzwzjc/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
