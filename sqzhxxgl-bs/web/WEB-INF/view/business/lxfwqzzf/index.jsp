...
<body>
	<ul class="breadcrumb" style="margin-bottom: 5px;">
	    ...
	    <li><a href="/taizhang/list/1">党群工作</a> <span class="divider">/</span></li>
	    <li class="active">联系服务群众走访名册</li>
  </ul>
			
	<div class="mianpan">
		  <div class="panhead">
		  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 联系服务群众走访名册
		  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="lxfwqzzf:add">
						<a  style="margin-bottom: 5px" href="/lxfwqzzf/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
							...
							<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="lxfwqzzf:update">
											...
											<a class="btn " href="/lxfwqzzf/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="lxfwqzzf:delete">
											<a class="btn  b_delete_" href="/lxfwqzzf/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/lxfwqzzf/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="lxfwqzzf:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/lxfwqzzf/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
