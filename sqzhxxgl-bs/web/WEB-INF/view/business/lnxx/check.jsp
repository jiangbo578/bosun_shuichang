  ...
  <div id="panbody">
	<div class="container">
		<table class="table table-striped table-bordered table-hover">
			...
			<thead>
			   <thead>
			<c:forEach  items="${datas }" var="lnxx" >
			 <tr>
					<th width="10%">学校名称：${lnxx.xxmc}</th>
					<th width="15%" colspan="2">建立时间:${lnxx.jlsj}</th>									
              ...
              <tr>
                ...
                <c:forEach  items="${lnxx.lnxxrylist}" var="lnxxry" varStatus="num">
                <tr>
			...
			<tr>
				<th>审核</th>
				<td>
				<form action="/tyssdj/check" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function() {
		...
		var pagination = new buguPagination('${current}',
				'${pages}', '${count}', '/tyssdj/check/', '/${businessFormId }');
