		...
		<table class="table table-striped table-bordered table-hover">
			...
			<td>
				...
				<tr>
					...
					<c:forEach var="xfzts"  items="${datas}" varStatus="num">
					<tr>
					   <td>${current==1?num.count+0:num.count+(10*(current-1))}</td>
						...
						<td>
					<div class="btn-group">
							<a  class="btn" href="/xfzts/item/detail/${xfzts.id }">详情</a><span class="empty"></span>
			...
			<tr>
				<th>审核</th>
				<td>
				<form action="/xfzts/check" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function() {
		...
		var pagination = new buguPagination('${current}',
				'${pages}', '${count}', '/xfzts/check/', '/${businessFormId }');
