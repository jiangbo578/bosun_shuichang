...
<body>
    ...
    <li class="active">退伍军人花名册</li><!--
    <li /twjrhmc/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 退伍军人花名册
  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="twjrhmc:add">
						<a  style="margin-bottom: 5px" href="/twjrhmc/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="twjrhmc:update">
											...
											<a class="btn " href="/twjrhmc/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="twjrhmc:delete">
											<a class="btn  b_delete_" href="/twjrhmc/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/twjrhmc/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="twjrhmc:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/twjrhmc/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
