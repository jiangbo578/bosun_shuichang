...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong>居委会成员名单</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/jwhcy/item/add" method="post">
			...
			<tr>
					<th>姓名：</th>
					<td><input name="name" type="text" data-rule="required;" id="name"/>
					</td>
				</tr>
				<tr>
					<th>性别：</th>
				...
				<tr>
					<th>职务：</th>
					<td>
					<input name="role"  id="role" type="text" data-rule="required;length[1~10]"/>
					</td>
				</tr>
				<tr>
					<th>是否属地化：</th>
				...
				<tr>
					<th>出生年月：</th>
					<td><input name="birthday" type="text" data-rule="required;" onClick="WdatePicker()" class="Wdate" id="birthday"/>
					</td>
				</tr>
				<tr>
					<th>文化程度：</th>
					<td><input name="degree" type="text" data-rule="required;" id="degree"/>
					</td>
				</tr>
				<tr>
					<th>政治面貌：</th>
...
<script type="text/javascript" src="/scripts/business/jwhcy.js"></script>
