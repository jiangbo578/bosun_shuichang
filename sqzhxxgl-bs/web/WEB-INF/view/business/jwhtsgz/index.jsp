...
<body>
	<ul class="breadcrumb" style="margin-bottom: 5px;">
	    ...
	    <li class="active">居委会特色工作</li>
  </ul>
			
	<div class="mianpan">
		  <div class="panhead">
		  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 居委会特色工作
		  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="jwhtsgz:add">
						<a  style="margin-bottom: 5px" href="/jwhtsgz/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
							...
							<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="jwhtsgz:update">
											...
											<a class="btn " href="/jwhtsgz/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="jwhtsgz:delete">
											<a class="btn  b_delete_" href="/jwhtsgz/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/jwhtsgz/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="jwhtsgz:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/jwhtsgz/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
