...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
    ...
    <li class="active">添加</li>
				...
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 社区优秀女性名册</div>
  <div id="panbody">
	<div class="container">
		<form action="/excellentwoman/item/add" method="post">
			<table>
				<tr>
					<th>姓名：</th>
				...
				<tr>
					<th>曾在何时何单位获得何种奖励：</th>
					<td>
						<textarea name="reward" style="width: 300px;height: 200px;" data-rule="required;length[1~50];" ></textarea>
					</td>
				</tr>	
				<tr>
					<th>备注（原籍）：</th>
