...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
    ...
    <li class="active">添加</li>
				...
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 实事项目</div>
  <div id="panbody">
	<div class="container">
		<form action="/sxsbsspro/item/add" method="post" class="well">
			<table>
				...
				<tr>
					<th> 人均年收入：</th>
					<td>
						<input name="incomeOfPerson" type="text"  data-rule="required;float;"></input>
					</td>
				</tr>
				<tr>
					<th>获评时间：</th>
