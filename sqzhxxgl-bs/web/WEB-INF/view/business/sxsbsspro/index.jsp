...
<body>
    ...
    <li class="active">双学双比活动情况</li><!--
    <li /sxsbsspro/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 双学双比活动情况
  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="sxsbsspro:add">
						<a  style="margin-bottom: 5px" href="/sxsbsspro/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="sxsbsspro:update">
											...
											<a class="btn " href="/sxsbsspro/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="sxsbsspro:delete">
											<a class="btn  b_delete_" href="/sxsbsspro/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/sxsbsspro/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="sxsbsspro:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/sxsbsspro/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
