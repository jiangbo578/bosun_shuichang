...
<body>
    ...
    <li class="active">红十字应急救护队名册</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i> 红十字应急救护队名册
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="hszyjjhd:add">
						<a  style="margin-bottom: 5px" href="/hszyjjhd/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="hszyjjhd:update">
											...
											<a class="btn " href="/hszyjjhd/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="hszyjjhd:delete">
											<a class="btn  b_delete_zcdygk" href="/hszyjjhd/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/hszyjjhd/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="hszyjjhd:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_xfqcwh" href="/hszyjjhd/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
