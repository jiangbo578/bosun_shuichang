...
<body>
    ...
    <li><a href="/taizhang/list/4">公共服务</a> <span class="divider">/</span></li>
    <li ><a href="/zxtjbdwb/list/1">街镇助学结对统计表（单位版）</a> <span class="divider">/</span></li>
    <li class="active">新增表</li>
  </ul>
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 街镇助学结对统计表（单位版）</div>
  <div id="panbody">
	<div class="container">
		<form  action="/zxtjbdwb/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('街镇助学结对统计表（单位版）('+myDate.getFullYear()+')');
