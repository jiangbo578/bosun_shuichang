...
<body>
 ...
 <li><a href="/taizhang/list/4">党群工作</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 小区台胞台属名单</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/tqjrs/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>类别：</th>
					<td><input name="type" type="text" data-rule="required;length[1~10]"></input>
					</td>
				</tr>
				<tr>
					<th>在台主要亲属：</th>
					<td><input name="qinqi" type="text" data-rule="length[1~10]"></input>
					</td>
				</tr>
...
<script src="/scripts/business/tqjrs.js"></script>
