...
<body>
    ...
    <li class="active">上海市社区公共体育设施器材详细情况登记表</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i> 上海市社区公共体育设施器材详细情况登记表
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="tyssqclb:add">
						<a  style="margin-bottom: 5px" href="/tyssqclb/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						
					</shiro:hasPermission>
					<a style="margin-bottom: 5px"  class="btn btn-info" href="/taizhang/list/3/${userRoleCode}"><i class="icon-share-alt"></i> 返回</a>
					<!-- <a href="#" class="tjBtn">提交审核</a> -->
						...
						<thead>
							<th style="text-align: left; text-indent: 10px">表单名称</th>
							<th>状态</th>
							<th>生成来源</th>
						...
						<tbody>
								...
								<tr class="bgColor">
									<td style="text-align: left; text-indent: 10px;">${businessForm.name}</td>
									<td>
									...
									<shiro:hasPermission name="tyssqclb:update">
											...
											<a class="btn " href="/tyssqclb/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="tyssqclb:delete">
											<a class="btn  b_delete_zcdygk" href="/tyssqclb/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/tyssqclb/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="tyssqclb:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_xfqcwh" href="/tyssqclb/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
