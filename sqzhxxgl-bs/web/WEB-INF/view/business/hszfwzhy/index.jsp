...
<body>
    ...
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
			...
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i> 红十字服务站会员名册
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="hszfwzhy:add">
						<a  style="margin-bottom: 5px" href="/hszfwzhy/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="hszfwzhy:update">
											...
											<a class="btn " href="/hszfwzhy/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="hszfwzhy:delete">
											<a class="btn  b_delete_zcdygk" href="/hszfwzhy/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/hszfwzhy/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="hszfwzhy:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_xfqcwh" href="/hszfwzhy/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
