...
<body>
    ...
    <li class="active">非法行医情况排摸信息表</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i>非法行医情况排摸信息表
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="ffxymp:add">
						<a  style="margin-bottom: 5px" href="/ffxymp/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="ffxymp:update">
											...
											<a class="btn " href="/ffxymp/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="ffxymp:delete">
											<a class="btn  b_delete_zcdygk" href="/ffxymp/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/ffxymp/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="ffxymp:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_ffxymp" href="/ffxymp/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	<script>
		$(function() {
			...
			$('.b_submit_ffxymp').on('click', function() {
