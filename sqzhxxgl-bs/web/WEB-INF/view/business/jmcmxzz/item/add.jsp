...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 村民小组长名单</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/jmcmxzz/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>小组名称：</th>
					<td><input name="xzmc" type="text"  id="xzmc" data-rule="required"/>
					</td>
				</tr>
				<tr>
					<th>姓名：</th>
				...
				<tr>
					<th>年龄：</th>
					<td><input name="nl" type="text" id="nl" data-rule="required:digits;range[1~100]"/>
					</td>
				</tr>
				<tr>
					<th>文化程度：</th>
