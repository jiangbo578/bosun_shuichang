...
<body>
    ...
    <li class="active">卫生自查情况记录表</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i>卫生自查情况记录表
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="wszcqk:add">
						<a  style="margin-bottom: 5px" href="/wszcqk/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="wszcqk:update">
											...
											<a class="btn " href="/wszcqk/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="wszcqk:delete">
											<a class="btn  b_delete_zcdygk" href="/wszcqk/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/wszcqk/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="wszcqk:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_xfqcwh" href="/wszcqk/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
