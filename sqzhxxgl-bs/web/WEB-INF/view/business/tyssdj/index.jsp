...
<body>
    ...
    <li class="active">上海市社区公共体育设施各类人员登记表</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i>上海市社区公共体育设施各类人员登记表
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="tyssdj:add">
						<a  style="margin-bottom: 5px" href="/tyssdj/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="tyssdj:update">
											...
											<a class="btn " href="/tyssdj/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="tyssdj:delete">
											<a class="btn  b_delete_zcdygk" href="/tyssdj/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/tyssdj/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="tyssdj:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_xfqcwh" href="/tyssdj/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
