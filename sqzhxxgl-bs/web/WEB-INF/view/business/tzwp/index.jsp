...
<body>
    ...
    <li class="active">经济林窝棚台帐</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i>经济林窝棚台帐
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="tzwp:add">
						<a  style="margin-bottom: 5px" href="/tzwp/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="tzwp:update">
											...
											<a class="btn " href="/tzwp/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="tzwp:delete">
											<a class="btn  b_delete_zcdygk" href="/tzwp/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/tzwp/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="tzwp:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_tzwp" href="/tzwp/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	<script>
		$(function() {
			...
			$('.b_submit_tzwp').on('click', function() {
