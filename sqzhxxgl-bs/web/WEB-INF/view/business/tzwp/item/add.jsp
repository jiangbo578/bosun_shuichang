...
<body>
  <ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li><a href="/wptz/list/1">经济林窝棚台帐</a> <span class="divider">/</span></li>
    <li class="active">添加</li>
  </ul>
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 经济林窝棚台帐 </div>
  <div id="panbody">
	<div class="container">
	
	
	
		<form action="/tzwp/item/add" method="post">
            <table> 
