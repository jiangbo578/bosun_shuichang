...
<body>
  <ul class="breadcrumb" style="margin-bottom: 5px;">
	...
	<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据修改</strong>健康社区工作统计表</div>
  <div id="panbody">
	<div class="container">
		<form action="/jksqgz/item/update" method="post">
		...
		<th style="color: red;">健康日宣传活动</th>
				...
				<button  class="btn btn-info" type="button" onclick="window.history.go(-1)" ><i class="icon-share-alt"></i> 返回</button>
					...
					<input type="hidden" name="id" value="${jksqgz.id}">
					</td>
				</tr>
			</table>
		</form>
