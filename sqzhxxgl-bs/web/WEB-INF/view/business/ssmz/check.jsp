...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
   <li><a href="/taizhang/list/4">党群工作</a> <span class="divider">/</span></li>
    <li ><a href="/ssmz/list/1">小区民主党派人士名单</a> <span class="divider">/</span></li>
	...
	<div class="container">
		<table class="table table-striped table-bordered table-hover">
			...
			<td>
				...
				<tbody>
					<c:forEach items="${datas }" var="ssmzItem" varStatus="num">
						<tr>
							<td>${current==1?num.count+0:num.count+(10*(current-1))}</td>
							<td>${ssmzItem.xm }</td>
							<td>${ssmzItem.xb }</td>
							<td><fmt:formatDate pattern='yyyy-MM-dd' value='${ssmzItem.csny }'/></td>
							<td>${ssmzItem.idcard }</td>
							<td>${ssmzItem.whcd }</td>
							<td>${ssmzItem.jtzz }</td>
			...
			<tr>
				<th>审核</th>
				<td>
				<form action="/ssmz/check" method="post">
	...
	<script>
		$(function() {
			...
			var pagination = new buguPagination('${current}',
					'${pages}', '${count}', '/ssmz/check/', '/${businessFormId }');
