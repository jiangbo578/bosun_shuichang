...
<body>
 ...
 <li><a href="/taizhang/list/3">公共服务</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 低保及一户多残残疾人家庭名册</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/cjrjt/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>户主姓名：</th>
					<td><input name="hzxm" type="text" id="phone" data-rule="required"/>
					</td>
				</tr>	
				<tr>
					<th>结对帮扶对象：</th>
					<td><input name="jddx" type="text" />
