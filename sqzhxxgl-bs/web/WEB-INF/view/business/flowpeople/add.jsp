...
<body>
    ...
    <li class="active">新增表</li>
			...
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 外来流动人口少数民族人员登记表</div>
  <div id="panbody">
	<div class="container">
		<form  action="/flowpeople/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('外来流动人口少数民族人员登记表('+myDate.getFullYear()+')');
