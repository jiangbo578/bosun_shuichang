...
<body>
 ...
 <li><a href="/taizhang/list/3">公共服务</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 参加社区体育活动的残疾人名册</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/tyhdcjr/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>特奥活动项目：</th>
					<td><input name="hdxm" type="text" id="hdxm" data-rule="required"/>
					</td>
				</tr>	
				<tr>
					<th>参与活动情况：</th>
					<td><input name="hdqk" type="text" id="hdqk" data-rule="required"/>
					</td>
				</tr>	
				<tr>
					<th>&nbsp;</th>
