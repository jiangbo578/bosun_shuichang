...
<div class="warp">
 ...
 <!-- include结束 -->
     ...
     <iframe width="100%"  style="min-height: 400px" scrolling="no" align="center" height="100%" id="win" name="win"  onload="javascript:iFrameHeight();" frameborder="0"  src="/kpxt/index/" id="cont">
   </iframe>
  </div>
 </div>  
</div>
