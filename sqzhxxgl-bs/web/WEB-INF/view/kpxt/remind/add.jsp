...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
  ...
  <i class="icon-list">&nbsp;&nbsp;</i><strong>业务添加</strong>
	...
	<div class="container">
		<form action="/assess/remind/add" method="post">

			<table>
			
				<tr>
					<th>月份：<input type="hidden" id="b_defaultDate" value="01月01日"/></th>
					<th>提醒日：</th>
					<th>绿灯开始日：</th>
					<th>黄灯开始日：</th>
					<th>红灯开始日：</th>
				...
				--%><tr>
					<th align="right">${10}月：</th>
					<td><input style="width: 150px"  type="text" name="remindDate" id="b_remindDate_${num.count }"
						onClick="WdatePicker({dateFmt:'${10 }月dd日'})" class="Wdate" />
					</td>
					<td><input type="text" style="width: 150px" name="greenStart" id="b_greenStart_${num.count }"
						onClick="WdatePicker({dateFmt:'MM月dd日', startDate:'%y-${10}-01', alwaysUseStartDate:true, minDate:'#F{$dp.$D(\'b_defaultDate\')}', maxDate:'#F{$dp.$D(\'b_remindDate_${num.count }\')}'})" class="Wdate" />
					</td>
					...
					<th><a href="javascript:void(0);" class="b_delete_business_remind">清除</a></th>
				</tr>
