...
<body>
    ...
    <li class="active">新增表</li>
			...
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 嘉定区社会组织预警网络信息员登记表</div>
  <div id="panbody">
	<div class="container">
		
		
		<form  method="post" action="/warningnetworker/add" >
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('嘉定区社会组织预警网络信息员登记表('+myDate.getFullYear()+')');
