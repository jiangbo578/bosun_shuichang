...
<body>
    ...
    <li ><a href="/dwwzjzcz/list/1">单位违章建筑处置统计表</a> <span class="divider">/</span></li>
    <li class="active">新增表</li>
  </ul>
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 单位违章建筑处置统计表</div>
  <div id="panbody">
	<div class="container">
		<form  action="/dwwzjzcz/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('单位违章建筑处置('+myDate.getFullYear()+')');
