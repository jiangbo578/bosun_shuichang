...
<body>
	<div class="container">
		<shiro:hasPermission name="tzbgk:add">    
			<a href="/tzbgk/add">添加</a>    
		</shiro:hasPermission>   
			...
			<tbody>
				<c:forEach items="${datas }" var="businessForm" varStatus="num">
					<tr>
						...
						<td>
							<shiro:hasPermission name="tzbgk:update">   
							<a href="/tzbgk/update/${businessForm.id }">修改</a><span class="empty"></span>
							</shiro:hasPermission>   
							<shiro:hasPermission name="tzbgk:delete">   
							<a href="/tzbgk/delete/${businessForm.id }" class="b_delete_tzbgk">删除</a><span class="empty"></span>
							</shiro:hasPermission>   
							<a href="/tzbgk/item/${businessForm.id }">名单</a><span class="empty"></span>
							<c:if test="${businessForm.processStatus != '书记审核'}">
								<a href="/tzbgk/submit/${businessForm.id }" class="b_submit_tzbgk">提交审核</a><span class="empty"></span>
							</c:if>
						</td>
					</tr>
				</c:forEach>
	...
	<script>
		$(function() {
			...
			$('.b_delete_tzbgk').on('click', function() {
			...
			$('.b_submit_tzbgk').on('click', function() {
