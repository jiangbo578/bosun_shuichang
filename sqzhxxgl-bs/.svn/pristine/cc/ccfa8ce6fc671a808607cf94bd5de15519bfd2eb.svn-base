...
<body>
  <ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li><a href="/hszfwztk/list/1">红十字服务站物资出借明细</a> <span class="divider">/</span></li>
    <li class="active">添加</li>
  </ul>
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 红十字服务站特困家庭名册</div>
  <div id="panbody">
	<div class="container">
	
	
	
		<form action="/hszfwztk/item/add" method="post">
