...
<body>
    ...
    <li class="active">新增表</li>
			...
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 党员志愿者参与活动情况</div>
  <div id="panbody">
	<div class="container">
		<form  action="/dyzyzcjhd/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('党员志愿者参与活动情况('+myDate.getFullYear()+')');
