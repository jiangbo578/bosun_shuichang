...
<body>
 ...
 <li><a href="/taizhang/list/4">党群工作</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 小区民主党派人士名单</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/mzdprs/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>文化程度：</th>
					<td><input name="whcd" type="text" id="whcd" data-rule="required;length[1~20];" ></input>
					</td>
				</tr>
				<tr>
					<th>党派：</th>
					<td><input name="dp" type="text" id="dp" data-rule="required;length[1~20];" />
					</td>
				</tr>
				<tr>
					<th>家庭住址：</th>
