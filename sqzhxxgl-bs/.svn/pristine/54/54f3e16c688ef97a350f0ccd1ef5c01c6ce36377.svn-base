...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong>小区团员青年登记表</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/tyqndj/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>文化程度：</th>
					<td><input name="whcd" type="text" id="whcd" data-rule="required;chinese;"/>
					</td>
				</tr>
				<tr>
					<th>电话：</th>
					<td><input name="phone" type="text" id="phone" data-rule="required:mobile;"/>
					</td>
				</tr>
				<tr>
					<th>备注：</th>
					<td><input name="note" type="text" id="note" />
					</td>
				</tr>
				<tr>
					<th>&nbsp;</th>
