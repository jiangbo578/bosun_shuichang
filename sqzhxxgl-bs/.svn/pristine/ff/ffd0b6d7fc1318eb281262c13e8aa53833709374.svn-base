...
<body>
    ...
    <li class="active">重点优抚对象花名册</li><!--
    <li /zdyfdxhmc/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 重点优抚对象花名册
  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="zdyfdxhmc:add">
						<a  style="margin-bottom: 5px" href="/zdyfdxhmc/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="zdyfdxhmc:update">
											...
											<a class="btn " href="/zdyfdxhmc/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="zdyfdxhmc:delete">
											<a class="btn  b_delete_" href="/zdyfdxhmc/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/zdyfdxhmc/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="zdyfdxhmc:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/zdyfdxhmc/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
