...
<body>
  <ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li class="active">添加</li>
				...
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 红十字服务站人员培训名册</div>
  <div id="panbody">
	<div class="container">
	
	
	
		<form action="/hszfwzrypx/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>出生年月：</th>
					<td><input name="birthday" type="text"  onClick="WdatePicker()" class="Wdate" data-rule="required;date"/>
					</td>
				</tr>
				...
				<tr>
					<th>培训时间：</th>
					<td><input name="pxsj" type="text"  onClick="WdatePicker()" class="Wdate" data-rule="required;date"/>
					</td>
				</tr>
				<tr>
					<th>备注：</th>
