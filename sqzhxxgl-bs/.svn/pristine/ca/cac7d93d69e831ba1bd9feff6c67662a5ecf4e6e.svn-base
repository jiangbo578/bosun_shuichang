...
<body>
    ...
    <li class="active">学习型社区建设</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 投诉举报咨询台账目录
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="zdsj:add">
						<a  style="margin-bottom: 5px" href="/zdsj/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						
					</shiro:hasPermission><a style="margin-bottom: 5px"  class="btn btn-info" href="/taizhang/list/3/${userRoleCode }"><i class="icon-share-alt"></i> 返回</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="zdsj:update">
											...
											<a class="btn " href="/zdsj/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="zdsj:delete">
											<a class="btn  b_delete_zcdygk" href="/zdsj/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/zdsj/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="zdsj:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_xfqcwh" href="/zdsj/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
