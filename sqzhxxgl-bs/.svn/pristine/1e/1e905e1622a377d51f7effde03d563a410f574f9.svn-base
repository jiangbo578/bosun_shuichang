			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="tsjbzx:add">
						<a  style="margin-bottom: 5px" href="/tsjbzx/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="tsjbzx:update">
											...
											<a class="btn " href="/tsjbzx/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="tsjbzx:delete">
											<a class="btn  b_delete_zcdygk" href="/tsjbzx/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/tsjbzx/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="tsjbzx:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_xfqcwh" href="/tsjbzx/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	<script>
		$(function() {
			...
			$('.b_submit_zcdygk').on('click', function() {
