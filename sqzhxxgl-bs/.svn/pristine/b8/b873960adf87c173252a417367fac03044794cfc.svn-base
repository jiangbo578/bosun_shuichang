...
<body>
 ...
 <li><a href="/taizhang/list/4">党群工作</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 妇代会委员名单</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/fudaiwy/item/add" method="post">
			...
			<table>
				...
				<tr>
					...
					<td>
						<select name="duty">
							<option value="">党（总）支委员</option>
							<option value="">村（居）委委员</option>
				...
				<tr>
					<th>兼职情况：</th>
					<td><input name="jzqk" type="text" id="jzqk" data-rule="length[1~30];"/>
					</td>
				</tr>
				<tr>
					<th>住址：</th>
