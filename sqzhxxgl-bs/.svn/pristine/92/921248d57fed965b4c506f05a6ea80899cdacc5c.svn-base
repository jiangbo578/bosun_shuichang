...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
    ...
    <li ><a href="/tyssqclb/list/1">上海市社区公共体育设施各类人员登记表</a> <span class="divider">/</span></li>
	...
	<div class="container">
		<table class="table table-striped table-bordered table-hover">
			...
			<td>
			 ...
			 <tr>
					<th width="10%">设施名称：${tyssqclblb.lb}</th>
					<th width="15%">地址:${tyssqclblb.address}</th>									
  ...
  <tbody>
                <c:forEach  items="${datas}" var="tyssqclb" varStatus="num">
                <tr>
			...
			<tr>
				<th>审核</th>
				<td>
				<form action="/tyssqclb/check" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function() {
		...
		var pagination = new buguPagination('${current}',
				'${pages}', '${count}', '/tyssqclb/check/', '/${businessFormId }');
