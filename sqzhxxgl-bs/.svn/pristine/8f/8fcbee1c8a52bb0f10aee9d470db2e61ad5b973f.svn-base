...
(function() {
	...
	function Ia(a, b) {
		...
		(c = a.indexOf(c)) !== -1;) {
			...
			if (d) {
				...
				if (f.length) f = f.join(":"), g = /\.([0-9])/, h = F.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = Ga(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = cb(f, e)
			}
			j.push(e);
			a = a.slice(c + 1);
			c = (d = !d) ? "}" : "{"
	...
	function Cb() {
		var a = F.global.useUTC,
			b = a ? "getUTC" : "get",
			c = a ? "setUTC" : "set";
		Ra = (a && F.global.timezoneOffset || 0) * 6E4;
	...
	var t, y = document,
		...
		Ob = /^[0-9]+$/,
		Pb = "stroke-width",
		eb, Ra, pb, qb, rb, Xa, fb, gb, Db, Eb, sb, Fb, Gb, G = {},
		...
		ya = function(a) {
			...
			(function(a) {
				a && a.stops ? d = Ua(a.stops, function(a) {
					return ya(a[1])
				}) : (c = Tb.exec(a)) ? b = [A(c[1]), A(c[2]), A(c[3]), parseFloat(c[4], 10)] : (c = Ub.exec(a)) ? b = [A(c[1], 16), A(c[2], 16), A(c[3], 16), 1] : (c = Vb.exec(a)) && (b = [A(c[1]), A(c[2]), A(c[3]), 1])
			})(a);
			return {
				get: function(c) {
					var f;
	...
	U.prototype = {
		...
		clip: function(a) {
			return this.attr("clip-path", a ? "url(" + this.renderer.url + "#" + a.id + ")" : N)
		},
		crisp: function(a) {
			var b, c = {},
		...
		css: function(a) {
			...
			if (e) {
				e = this.textWidth = a && a.width && d.nodeName.toLowerCase() === "text" && A(a.width);
				b && (a = q(b, c));
				this.styles = a;
				e && (fa || !aa && this.renderer.forExport) && delete a.width;
				if (Aa && !aa) D(this.element, a);
				else {
					b = function(a, b) {
		...
		getBBox: function() {
			...
			if (!a) {
				...
				if (b.isSVG) {
					...
					if (e) a.width = O(d * ea(g)) + O(c * Z(g)), a.height = O(d * Z(g)) + O(c * ea(g))
				}
				this.bBox = a;
				h && (b.cache[h] = a)
			}
		...
		add: function(a) {
			...
			if (f) c.handleZ = !0, f = A(f);
			if (c.handleZ) {
				a = d.childNodes;
				for (g = 0; g < a.length; g++) if (b = a[g], c = H(b, "zIndex"), b !== e && (A(c) > f || !r(f) && r(c))) {
					d.insertBefore(e, b);
					h = !0;
					break
				}
		...
		dashstyleSetter: function(a) {
			...
			if (a = a && a.toLowerCase()) {
				...
				for (b = a.length; b--;) a[b] = A(a[b]) * this.element.getAttribute("stroke-width");
				a = a.join(",");
	...
	U.prototype.translateXSetter = U.prototype.translateYSetter = U.prototype.rotationSetter = U.prototype.verticalAlignSetter = U.prototype.scaleXSetter = U.prototype.scaleYSetter = function(a, b) {
		this[b] = a;
		this.doTransform = !0
	};
	var ta = function() {
	...
	ta.prototype = {
		...
		init: function(a, b, c, d, e) {
			...
			this.createElement("desc").add().element.appendChild(y.createTextNode("Created with Highcharts 4.0.0"));
		...
		buildText: function(a) {
			for (var b = a.element, c = this, d = c.forExport, e = m(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = H(b, "x"), k = a.styles, l = a.textWidth, o = k && k.lineHeight, n = g.length, s = function(a) {
					return o ? A(o) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : k && k.fontSize || c.style.fontSize || 12).h
				}; n--;) b.removeChild(g[n]);
			!f && e.indexOf(" ") === -1 ? b.appendChild(y.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, l && !a.added && this.box.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), p(e, function(e, f) {
				...
				p(g, function(e) {
					if (e !== "" || g.length === 1) {
						...
						i.test(e) && !d && (H(m, "onclick", 'location.href="' + e.match(i)[1] + '"'), D(m, {
							cursor: "pointer"
						}));
		...
		label: function(a, b, c, d, e, f, g, h, i) {
			function j() {
				...
				if (A) {
					if (!m) a = u(-Q * x), b = h ? -na : 0, n.box = m = d ? o.symbol(d, a, b, n.width, n.height, B) : o.rect(a, b, n.width, n.height, 0, B[Pb]), m.attr("fill", N).add(n);
					m.isImg || m.attr(q({
						width: u(n.width),
						height: u(n.height)
					}, B));
		...
		R.VMLElement = X = {
			...
			setSpanRotation: function() {
				var a = this.rotation,
					...
					c = ea(a * Ca);
				D(this.element, {
					filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : N
				})
			},
				...
				if (a) {
					...
					for (e = 1; e <= 3; e++) {
						...
						h = Y(g.prepVML(j), null, {
							left: A(i.left) + m(a.offsetX, 1),
							top: A(i.top) + m(a.offsetY, 1)
						});
						if (c) h.cutOff = l + 1;
			...
			fillSetter: function(a, b, c) {
				...
				else if (d !== "IMG") c.filled = a !== N, this.setAttr("fillcolor", this.renderer.color(a, c, b, this))
			},
			opacitySetter: sa,
		...
		var ga = {
			...
			color: function(a, b, c, d) {
				...
				if (i) {
					...
					if (c === "fill") if (i === "gradient") c = o.x1 || o[0] || 0, a = o.y1 || o[1] || 0, n = o.x2 || o[2] || 0, o = o.y2 || o[3] || 0, x = 'angle="' + (90 - T.atan((o - a) / (n - c)) * 180 / ma) + '"', q();
					else {
						var j = o.r,
							t = j * 2,
							u = j * 2,
							...
							w, j = function() {
								...
								x = 'src="' + F.global.VMLRadialGradientURL + '" size="' + t + "," + u + '" origin="0.5,0.5" position="' + y + "," + B + '" color2="' + Q + '" ';
								q()
							};
						d.added ? j() : d.onAdd = j;
						j = J
	...
	Sa.prototype = {
		...
		render: function(a, b, c) {
			...
			if (o && Q) r === "inside" && (Q = -Q), d.opposite && (Q = -Q), h = this.getMarkPath(y, w, Q, o * B, g, f), n ? n.animate({
				d: h,
				opacity: c
	...
	la.prototype = {
		...
		setOptions: function(a) {
			this.options = w(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], w(F[this.coll], a))
		},
		...
		setTickPositions: function(a) {
			...
			if (!h) e = a[0], f = a[a.length - 1], h = b.minPointOffset || 0, d.startOnTick ? b.min = e : b.min - h > e && a.shift(), d.endOnTick ? b.max = f : b.max + h < f && a.pop(), a.length === 1 && (d = O(b.max) > 1E13 ? 1 : 0.001, b.min -= d, b.max += d)
		},
		...
		getOffset: function() {
			var a = this,
				...
				y, A, z, B, na = h === 2 ? c.fontMetrics(s.style.fontSize).b : 0;
			...
			if (j || a.isLinked) {
				...
				if (a.horiz && !a.staggerLines && w && !s.rotation) {
					for (q = a.reversed ? [].concat(e).reverse() : e; u < w;) {
						j = [];
						y = !1;
						for (s = 0; s < q.length; s++) A = q[s], z = (z = f[A].label && f[A].label.getBBox()) ? z.width : 0, B = s % u, z && (A = a.translate(A), j[B] !== t && A < j[B] && (y = !0), j[B] = A + z);
						if (y) u++;
						else break
					}
		...
		render: function() {
			...
			if (v || h) if (a.minorTickInterval && !a.categories && p(a.getMinorTickPositions(), function(b) {
				...
				if (c % 2 === 0 && b < a.max) n[b] || (n[b] = new R.PlotLineOrBand(a)), w = b + J, z = i[c + 1] !== t ? i[c + 1] + J : a.max, n[b].options = {
					from: g ? ia(w) : w,
					to: g ? ia(z) : z,
					color: m
	...
	la.prototype.getTimeTicks = function(a, b, c, d) {
		var e = [],
			...
			k = a.count;
		if (r(b)) {
			j >= z.second && (i.setMilliseconds(0), i.setSeconds(j >= z.minute ? 0 : k * S(i.getSeconds() / k)));
			if (j >= z.minute) i[Db](j >= z.hour ? 0 : k * S(i[pb]() / k));
			if (j >= z.hour) i[Eb](j >= z.day ? 0 : k * S(i[qb]() / k));
			if (j >= z.day) i[sb](j >= z.month ? 1 : k * S(i[Xa]() / k));
			j >= z.month && (i[Fb](j >= z.year ? 0 : k * S(i[fb]() / k)), h = i[gb]());
			j >= z.year && (h -= h % k, i[Gb](h));
			if (j === z.week) i[sb](i[Xa]() - i[rb]() + m(d, 1));
			b = 1;
			Ra && (i = new Date(i.getTime() + Ra));
			h = i[gb]();
			for (var d = i.getTime(), l = i[fb](), o = i[Xa](), n = g ? Ra : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;) e.push(d), j === z.year ? d = eb(h + b * k, 0) : j === z.month ? d = eb(h, l + b * k) : !g && (j === z.day || j === z.week) ? d = eb(h, l, o + b * k * (j === z.day ? 1 : 7)) : d += j * k, b++;
			e.push(d);
			p(vb(e, function(a) {
				return j <= z.hour && a % z.day === n
			}), function(a) {
				f[a] = "day"
			})
		}
	...
	la.prototype.normalizeTimeTickInterval = function(a, b) {
		var c = b || [
			...
			f = d[1],
			g;
		for (g = 0; g < c.length; g++) if (d = c[g], e = z[d[0]], f = d[1], c[g + 1] && a <= (e * f[f.length - 1] + z[c[g + 1][0]]) / 2) break;
		e === z.year && a < 5 * e && (f = [1, 2, 5]);
	...
	la.prototype.getLogTickPositions = function(a, b, c, d) {
		...
		else if (a >= 0.08) for (var f = S(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
			i = e.length;
	...
	Mb.prototype = {
		...
		tooltipHeaderFormatter: function(a) {
			...
			if (g && !e) {
				if (f) for (h in z) {
					if (z[h] >= f || z[h] <= z.day && a.key % z[h] > 0) {
						e = d[h];
						break
					}
				} else e = d.day;
	...
	Wa.prototype = {
		init: function(a, b) {
			...
			this.pinchDown = [];
			this.lastValidTouch = {};
			if (R.Tooltip && b.tooltip.enabled) a.tooltip = new Mb(a, b.tooltip), this.followTouchMove = b.tooltip.followTouchMove;
			this.setDOMEvents()
		},
		...
		runPointActions: function(a) {
			...
			if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
				f = [];
				i = c.length;
				for (j = 0; j < i; j++) if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series) e._dist = O(l - e.clientX), k = C(k, e._dist), f.push(e);
		...
		onContainerClick: function(a) {
			...
			a.cancelBubble = !0;
			if (!b.cancelClick) c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, q(c, {
				pageX: g.left + d + (f ? b.plotWidth - i : h),
				pageY: g.top + e + (f ? b.plotHeight - h : i)
			}), E(c.series, "click", q(a, {
				point: c
			})), b.hoverPoint && c.firePointEvent("click", a)) : (q(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && E(b, "click", a))
		},
	...
	lb.prototype = {
		init: function(a, b) {
			var c = this,
				...
				f = b.itemMarginTop || 0;
			this.options = b;
			if (b.enabled) c.baseline = A(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = w(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = m(b.symbolWidth, 16), c.pages = [], c.render(), K(c.chart, "endResize", function() {
		...
		renderItem: function(a) {
			...
			c = q.getBBox();
			f = a.legendItemWidth = d.itemWidth || a.legendItemWidth || f + g + c.width + k + (x ? 20 : 0);
	...
	Ya.prototype = {
		...
		initSeries: function(a) {
			...
			(b = G[a.type || b.type || b.defaultSeriesType]) || ra(17, !0);
			b = new b;
			b.init(this, a);
			return b
		},
		...
		setChartSize: function(a) {
			...
			this.clipBox = {
				...
				height: S(this.plotSizeY - v(d, h[2]) / 2 - c)
			};
		...
		propFromSeries: function() {
			...
			p(["inverted", "angular", "polar"], function(g) {
				...
				for (e = d && d.length; !f && e--;)(c = G[d[e].type]) && c.prototype[g] && (f = !0);
				a[g] = f
			})
		},
		linkSeries: function() {
	...
	M.prototype = {
		...
		setOptions: function(a) {
			...
			this.userOptions = a;
			c = w(e, c.series, a);
			this.tooltipOptions = w(F.tooltip, F.plotOptions[this.type].tooltip, b.tooltip, d.series && d.series.tooltip, d[this.type] && d[this.type].tooltip, a.tooltip);
			...
			if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData) p(a, function(a, b) {
				...
				if (s && h > s) {
					...
					if (ha(k)) {
						...
						e.xIncrement = o
					} else if (La(k)) if (v) for (c = 0; c < h; c++) i = a[c], q[c] = i[0], r[c] = i.slice(1, v + 1);
		...
		generatePoints: function() {
			...
			if (b && (g !== (c = b.length) || j)) for (o = 0; o < c; o++) if (o === h && !j && (o += g), b[o]) b[o].destroyElements(), b[o].plotX = t;
			this.data = b;
			this.points = l
		},
		...
		translate: function() {
			...
			for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !! this.modifyValue, i = a.pointPlacement, j = i === "between" || ha(i), k = a.threshold, a = 0; a < g; a++) {
				...
				if (b && this.visible && p && p[o]) p = p[o], n = p.points[this.index + "," + a], s = n[0], n = n[1], s === 0 && (s = m(k, e.min)), e.isLog && s <= 0 && (s = null), l.total = l.stackTotal = p.total, l.percentage = p.total && l.y / p.total * 100, l.stackY = n, p.setOffset(this.pointXOffset || 0, this.barW || 0);
		...
		drawPoints: function() {
			...
			if (d.enabled !== !1 || this._hasPointMarkers) for (f = b.length; f--;) if (g = b[f], d = S(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = s && i.enabled === t || i.enabled, o = c.isInsidePlot(u(d), e, c.inverted), a && e !== t && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = m(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[o ? "show" : "hide"](!0).animate(q({
				x: d - h,
				y: e - h
			}, k.symbolName ? {
				width: 2 * h,
	...
	M.prototype.setStackedPoints = function() {
		if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
			...
			for (q = 0; q < d; q++) {
				...
				m = l[m][r];
				m.points[p] = [m.cum || 0];
				e === "percent" ? (n = n ? h : i, j && l[n] && l[n][r] ? (n = l[n][r], m.total = n.total = v(n.total, m.total) + O(u) || 0) : m.total = da(m.total + (O(u) || 0))) : m.total = da(m.total + (u || 0));
				m.cum = (m.cum || 0) + (u || 0);
	...
	var pa = ka(M, {
		...
		getSegmentPath: function(a) {
			...
			if (e.stacking && !this.closedStacks) for (d = a.length - 1; d >= 0; d--) g = m(a[d].yBottom, f), d < a.length - 1 && e.step && c.push(a[d + 1].plotX, g), c.push(a[d].plotX, g);
		...
		translate: function() {
			...
			p(a.points, function(c) {
				var d = m(c.yBottom, f),
					...
					x;
				x = v(p, d) - t;
				O(x) < g && g && (x = g, t = u(O(t - f) > g ? d - g : f - (e.translate(c.y, 0, 1, 0, 1) <= f ? g : 0)));
				c.barX = q;
				c.pointWidth = h;
	...
	M.prototype.drawDataLabels = function() {
		var a = this,
			...
			e = a.points,
			f, g, h, i;
		if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), i = a.plotGroup("dataLabelsGroup", "data-labels", "hidden", d.zIndex || 6), !a.hasRendered && m(d.defer, !0) && (i.attr({
			opacity: 0
	...
	if (G.pie) G.pie.prototype.drawDataLabels = function() {
		var a = this,
			b = a.data,
			c, d = a.chart,
			...
			for (D = 2; D--;) {
				...
				if (l > 0) {
					...
					for (B = 0; B < I; B++) {
						...
						c = 9999;
						var P, N;
						for (N = 0; N < w; N++) P = O(b[N] - x[1]), P < c && (c = P, F = N);
						if (F < B && b[B] !== null) F = B;
						else for (w < I - B + F && b[B] !== null && (F = w - I + B); b[F] === null;) F++;
						K.push({
							i: F,
							y: b[F]
						});
				...
				for (B = 0; B < I; B++) {
					...
					c = x[1];
					if (l > 0) {
						if (w = K.pop(), F = w.i, C = w.y, c > C && b[F + 1] !== null || c < C && b[F - 1] !== null) C = c
					} else C = c;
					z = e.justify ? o[0] + (D ? -1 : 1) * (n + l) : a.getX(F === 0 || F === b.length - 1 ? c : C, D);
					t._attr = {
						visibility: G,
						align: x[6]
					};
					...
					t.connX = z;
					t.connY = C;
					if (this.options.size === null) w = t.width, z - w < f ? E[3] = v(u(w - z + f), E[3]) : z + w > h - f && (E[1] = v(u(z + w - h + f), E[1])), C - y / 2 < 0 ? E[0] = v(u(-C + y / 2), E[0]) : C + y / 2 > d && (E[2] = v(u(C + y / 2 - d), E[2]))
				}
			}
			if (Ba(E) === 0 || this.verifyDataLabelOverflow(E)) this.placeDataLabels(), r && g && p(this.points, function(b) {
				i = b.connector;
				x = b.labelPos;
				if ((t = b.dataLabel) && t._pos) G = t._attr.visibility, z = t.connX, C = t.connY, j = k ? ["M", z + (x[6] === "left" ? 5 : -5), C, "C", z, C, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", z + (x[6] === "left" ? 5 : -5), C, "L", x[2], x[3], "L", x[4], x[5]], i ? (i.animate({
					d: j
	...
	}, G.pie.prototype.alignDataLabel = sa, G.pie.prototype.verifyDataLabelOverflow = function(a) {
		var b = this.center,
			c = this.options,
			d = c.center,
			e = c = c.minSize || 80,
	...
	if (G.column) G.column.prototype.alignDataLabel = function(a, b, c, d, e) {
		var f = this.chart,
			g = f.inverted,
	...
	if (G.column) ga.prototype.drawTracker = P.drawTrackerPoint;
	if (G.pie) G.pie.prototype.drawTracker = P.drawTrackerPoint;
	if (G.scatter) pa.prototype.drawTracker = P.drawTrackerPoint;
	if (G.gauge) G.gauge.prototype.drawTracker = P.drawTrackerPoint;
	q(lb.prototype, {
	...
	q(Ea.prototype, {
		...
		haloPath: function(a) {
			...
			return b.renderer.symbols.circle(b.plotLeft + this.plotX - a, b.plotTop + this.plotY - a, a * 2, a * 2)
		}
	});
	q(M.prototype, {
		...
		setTooltipPoints: function(a) {
			...
			if (!(this.options.enableMouseTracking === !1 || this.singularTooltips)) {
				...
				for (i = 0; i < a; i++) if (e = b[i], c = e.x, c >= f.min && c <= f.max) {
					h = b[i + 1];
					c = d === t ? 0 : d + 1;
					for (d = b[i + 1] ? C(v(0, S((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g; c >= 0 && c <= d;) j[c++] = e
				}
