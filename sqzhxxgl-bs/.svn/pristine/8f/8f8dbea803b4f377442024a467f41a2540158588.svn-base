...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
    ...
    <li class="active">添加</li>
				...
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 年度发展对象</div>
  <div id="panbody">
	<div class="container">
		<form action="/ndfzdx/item/add" method="post">
			<table>
				<!-- <tr>
				...
				<tr>
					<th>民族：</th>
					<td><input name="mz" type="text" data-rule="required;length[1~10];" id="mz" data-rule="required"/>
					</td>
				</tr>
				<tr>
					<th>出生年月：</th>
				...
				<tr>
					...
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" id="pxsj"/>
					</td>
				</tr>
				<tr>
					<th>拟发展时间:</th>
					<td><input name="fzsj" type="text" data-rule="required;date" 
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" id="fzsj"/>
					</td>
				</tr>
				<tr>
					<th>培养联系人 ：</th>
					<td><input name="pxlxr" type="text" id="pxlxr" data-rule="required;length[1~20];"></input>
					</td>
				</tr>
				<tr>
					<th>居住地址 ：</th>
					<td><input name="address" type="text" id="address"  data-rule="required;"></input>
					</td>
				</tr>
					<tr>
					<th>&nbsp;</th>
