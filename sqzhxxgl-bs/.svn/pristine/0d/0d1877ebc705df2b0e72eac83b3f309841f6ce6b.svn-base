...
<body>
  <ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li class="active">添加</li>
				...
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 自办酒会所情况表 </div>
  <div id="panbody">
	<div class="container">
	
	
	
		<form action="/zbjshs/item/add" method="post"><%--
			...
			--%><table> 
				...
				<tr>
					<th>承办桌数：</th>
					<td><input name="cbzs" type="text" data-rule="required;number" />
					</td>
				</tr>
				<tr>
					<th>区食安办备案：</th>
				...
				<tr>
					<th>月实际承办桌数：</th>
					<td><input name="sjzs" type="text" data-rule="required;number" />
					</td>
				</tr>
				<tr>
					<th>月实际承办户数：</th>
					<td><input name="sjhs" type="text" data-rule="required;number" />
					</td>
				</tr>
				<tr>
					<th>备注：</th>
