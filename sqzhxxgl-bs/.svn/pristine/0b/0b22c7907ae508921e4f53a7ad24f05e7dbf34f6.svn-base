    ...
    if (l) {
        ...
        if (n.width > h) {
            ...
            if (isNaN(s)) {
                ...
                if (0 == k) for (p = 1; p < h; p++) s = Math.round(b.length / h * p),
...
AmCharts.AxisBase = AmCharts.Class({
    ...
    pushAxisItem: function(a, b) {
        ...
        if (d = a.getLabel()) this.labelsSet.push(d),
        d.click(function(b) {
...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) g = !0;
                ...
                if (0 < c) {
                    ...
                    for (d = this.fillAlpha = 0; d < c; d++) {
                        ...
                        var z = NaN;
                        isNaN(x.value) || (z = this.getCoordinate(x.value), v = new this.axisItemRenderer(this, z, x.label, !0, NaN, (E - z) / 2, x), this.pushAxisItem(v, A));
                ...
                this.exponential = !1;
                for (d = p; d < q; d += n) t = AmCharts.roundTo(this.step * d + this.min, s),
                -1 != String(t).indexOf("e") && (this.exponential = !0, String(t).split("e"));
                this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
                var s = this.step,
                H, t = this.minorGridAlpha;
                this.minorGridEnabled && (H = this.getMinorGridStep(s, this.stepWidth * s));
                for (d = p; d < q; d += n) if (p = s * d + this.min, h && this.max - this.min > 5 * this.min && (p -= this.min), p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p) if (isNaN(w) || Number(AmCharts.toFixed(p, w)) == p) { ! 0 === h && (0 === p && (p = this.minReal), r > this.logGridLimit && (p = Math.pow(10, d)));
                    v = this.formatValue(p);
                    ...
                    if (!isNaN(H) && 0 < t && d < q - 1) {
                        ...
                        for (c = 1; c < s / H; c++) u = this.getCoordinate(p + H * c),
                        u = new this.axisItemRenderer(this, u, "", !1, 0, 0, !1, !1, 0, !0),
                        this.pushAxisItem(u);
                        this.gridAlpha = v
                    }
                }
            ...
            e = this.labelsSet;
            this.positionTitle();
            "radar" != a.type ? (a = this.viX, f = this.viY, b.translate(a, f), e.translate(a, f)) : h.toFront(); ! this.visible || g ? (b.hide(), h.hide(), e.hide()) : (b.show(), h.show(), e.show());
            this.axisY = this.y - this.viY;
            this.axisX = this.x - this.viX
        }
    },
    formatValue: function(a, b) {
        var c = this.exponential,
        d = this.logarithmic,
        e = this.numberFormatter,
        f = this.chart; ! 0 === this.logarithmic && (c = -1 != String(a).indexOf("e") ? !0 : !1);
        this.useScientificNotation && (c = !0);
        this.usePrefixes && (c = !1);
        c ? (valueText = -1 == String(a).indexOf("e") ? a.toExponential(15) : String(a), c = valueText.split("e"), f = Number(c[0]), c = Number(c[1]), f = AmCharts.roundTo(f, 14), 10 == f && (f = 1, c += 1), valueText = f + "e" + c, 0 === a && (valueText = "0"), 1 == a && (valueText = "1")) : (d && (c = String(a).split("."), c[1] ? (e.precision = c[1].length, 0 > i && (e.precision = Math.abs(i))) : e.precision = -1), valueText = this.usePrefixes ? AmCharts.addPrefix(a, f.prefixesOfBigNumbers, f.prefixesOfSmallNumbers, e, !b) : AmCharts.formatNumber(a, e, e.precision));
        this.duration && (valueText = AmCharts.formatDuration(a, this.duration, "", this.durationUnits, this.maxInterval, e));
        this.recalculateToPercents ? valueText += "%": (e = this.unit) && (valueText = "left" == this.unitPosition ? e + valueText: valueText + e);
    ...
    stackGraphs: function(a) {
        ...
        if (q && ("regular" == b || "100%" == b)) for (n = 0; n < h.length; n++) m = h[n],
        m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (k && (m.stackGraph = k), k = m));
        for (k = this.start; k <= this.end; k++) {
            var r = 0;
            for (n = 0; n < h.length; n++) if (m = h[n], m.hidden) m.newStack && (e[k] = NaN, d[k] = NaN);
            else if (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable) if (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g)) m.newStack && (e[k] = NaN, d[k] = NaN);
            else {
    ...
    recalculate: function() {
        ...
        for (c = 0; c < b.length; c++) {
            ...
            if (d.valueAxis == this) {
                ...
                if (l = a.recalculateFromDate) a.dataDateFormat && (l = AmCharts.stringToDate(l, a.dataDateFormat)),
...
AmCharts.RecItem = AmCharts.Class({
    construct: function(a, b, c, d, e, f, g, h, k, l, m) {
        ...
        if ("H" == Sa) {
            ...
            oa && ("right" == na ? (aa += da + $ + Y, pa += ba, aa = N ? aa - w: aa + w) : (aa -= $, N || (aa -= u + w)));
            f && (D += f);
            N = -3;
            "right" == na && (N += ba);
            T && (D > L + 1 || D < N) && (T.remove(), T = null)
        }
        oa && oa.translate(aa, pa); ! 1 === a.visible && (oa && oa.remove(), T && (T.remove(), T = null));
        T && (T.attr({
            "text-anchor": W
...
AmCharts.AmChart = AmCharts.Class({
    ...
    initChart: function() {
        ...
        this.mouseMode = a; (a = this.container) ? (a.container.innerHTML = "", this.chartDiv.appendChild(a.container), a.setSize(this.realWidth, this.realHeight)) : a = new AmCharts.AmDraw(this.chartDiv, this.realWidth, this.realHeight, this);
    ...
    measure: function() {
        ...
        if (a) {
            ...
            this.balloon.chart = this; (a != this.previousWidth || f != this.previousHeight) && 0 < a && 0 < f && (b.style.width = a + "px", b.style.height = f + "px", e && e.setSize(a, f));
    ...
    addMouseWheel: function() {
        var a = this;
        window.addEventListener && !a.wheelAdded && (window.addEventListener("DOMMouseScroll",
        function(b) {
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function() {
        ...
        cb = 0,
        mb = 0,
        nb, ob, db, eb, pb = this.fillColorsR,
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < ia) {
                ...
                if (this.dashLengthField) for (J = ia; - 1 < J; J--) if (T = d[J], y = T.axes[f.id].graphs[b], !isNaN(y.dashLength)) {
        ...
        for (J = ia; J <= da; J++) {
            ...
            if (va) {
                ...
                if ("candlestick" == g || "ohlc" == g) U = va.close,
                sb = va.low,
                xa = f.getCoordinate(sb),
                rb = va.high,
                ya = f.getCoordinate(rb);
                ka = va.open;
                B = f.getCoordinate(U);
                ...
                if (!tb && U < ka || tb && U < pa) y.isNegative = !0,
                Da && (Ca = Da),
                Va && (Oa = Va),
                void 0 != wa && (ua = wa);
                Wa = !1;
                ...
                case "line":
                    if (isNaN(U)) w || (this.drawLineGraph(v, t, O, P), v = [], t = [], O = [], P = []);
                        ...
                        if (Math.abs(C - gb) >= ib || Math.abs(B - hb) >= ib) v.push(C),
                        t.push(B),
                        gb = C,
                        hb = B;
                        ca = C;
                        ja = B;
                        fa = C;
                        ga = B; ! Ea || isNaN(K) || isNaN(M) || (O.push(M), P.push(K));
                        if (Wa || void 0 != y.lineColor || void 0 != y.fillColors || !isNaN(y.dashLength)) this.drawLineGraph(v, t, O, P),
                        v = [C],
                        t = [B],
                        O = [],
                        P = [],
                        !Ea || isNaN(K) || isNaN(M) || (O.push(M), P.push(K)),
                        l ? Fa ? (this.lineColorSwitched = oa, this.fillColorsSwitched = pb) : (this.lineColorSwitched = wa, this.fillColorsSwitched = Da) : (this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors),
                        this.dashLengthSwitched = y.dashLength;
                        y.gap && (this.drawLineGraph(v, t, O, P), v = [], t = [], O = [], P = [])
                    }
                    break;
                case "smoothedLine":
                    if (isNaN(U)) w || (this.drawSmoothedGraph(v, t, O, P), v = [], t = [], O = [], P = []);
                    else {
                        if (Math.abs(C - gb) >= ib || Math.abs(B - hb) >= ib) v.push(C),
                        t.push(B),
                        gb = C,
                        ...
                        y.gap && (this.drawSmoothedGraph(v, t, O, P), v = [], t = [], O = [], P = [])
                    }
                    break;
                case "step":
                    if (!isNaN(U)) {
                ...
                case "column":
                    ...
                    if (!isNaN(U)) {
                        ...
                        if (! (U < Lb && ka < Lb || U > Mb && ka > Mb)) if (q) {
                            ...
                            ea = B - K;
                            var Zb = Q;
                            Q = AmCharts.fitToBounds(Q, this.dy, n);
                            ea += Zb - Q;
                            ea = AmCharts.fitToBounds(ea, -Q + G * L, n - Q);
                            if (X < m + L * F && 0 < R) if (this.showOnAxis && (Q -= G / 2), ra = new AmCharts.Cuboid(e, R, ea, F - a.d3x, G - a.d3y, Ca, Oa, Y, qa, this.lineAlpha, D, s, q, W, Ya, Kb), 0 > U && "middle" != N && "inside" != N) N = "bottom";
                        ...
                        if (ra && (sa = ra.set, y.columnGraphics = sa, sa.translate(X, Q), this.columnsSet.push(sa), (y.url || this.showHandOnHover) && sa.setAttr("cursor", "pointer"), !ba)) {
                            ...
                            "3d" == V && (q ? (H = (this.end + 1 - J) * z - c - 1E3 * this.depthCount, ca += F * this.columnIndex, fa += F * this.columnIndex, y.y += F * this.columnIndex) : (H = (z - c) * (J + 1) + 1E3 * this.depthCount, ca += 3, ja += G * this.columnIndex + 7, ga += G * this.columnIndex, y.y += G * this.columnIndex));
                            if ("regular" == V || "100%" == V)"inside" != N && (N = "middle"),
                            H = q ? 0 < va.value ? (this.end + 1 - J) * z + c: (this.end + 1 - J) * z - c: 0 < va.value ? z * J + c: z * J - c;
                    ...
                    if (!isNaN(ka) && !isNaN(U)) {
                        ...
                        if (q) {
                            if (Q = B - h / 2, X = M, R = h, Q + R > n && (R = n - Q), 0 > Q && (R += Q, Q = 0), Q < n && 0 < R) {
                                var wb, xb;
                                U > ka ? (wb = [C, Ia], xb = [M, Ha]) : (wb = [M, Ia], xb = [C, Ha]); ! isNaN(Ia) && !isNaN(Ha) && B < n && 0 < B && (jb = AmCharts.line(e, wb, [B, B], qa, $, Y), vb = AmCharts.line(e, xb, [B, B], qa, $, Y));
                                ea = C - M;
                            ...
                            tb && U >= ka && (Oa = 0);
                            var ra = new AmCharts.Cuboid(e, R, ea, F, G, Ca, Oa, Y, qa, $, D, s, q, W, Ya),
                            yb,
                            zb;
                            U > ka ? (yb = [B, ya], zb = [K, xa]) : (yb = [K, ya], zb = [B, xa]); ! isNaN(ya) && !isNaN(xa) && C < m && 0 < C && (jb = AmCharts.line(e, [C, C], yb, qa, $, Y), vb = AmCharts.line(e, [C, C], zb, qa, $, Y))
                        }
                        ra && (sa = ra.set, y.columnGraphics = sa, Z.push(sa), sa.translate(X, Q - Y / 2), (y.url || this.showHandOnHover) && sa.setAttr("cursor", "pointer"), jb && (Z.push(jb), Z.push(vb)), ca = C, ja = B, q ? (ga = B, fa = C, "open" == k && (fa = M), "high" == k && (fa = Ia), "low" == k && (fa = Ha)) : (ga = B, "open" == k && (ga = K), "high" == k && (ga = ya), "low" == k && (ga = xa), fa = C), ba || (y.x = q ? Q + R / 2 : X + R / 2, this.animateColumns(ra, J, C, M, B, K), this.addListeners(sa, y)))
                    }
                    break;
                case "ohlc":
                ...
                if (!ba && !isNaN(U)) {
                    ...
                    if (this.end - this.start <= Pb || 0 === Pb) {
                        var Ja = this.createBullet(y, fa, ga, J);
                        Ja || (Ja = 0);
                        ...
                        if (Qb) {
                            ...
                            case "bottom":
                                ...
                                break;
                            case "middle":
                                "column" == g && (q ? (La = -(Ma / 2) + this.fontSize / 2, Ka = -(C - M) / 2 - F, Math.abs(C - M) < Qa && !this.showAllValueLabels && (ha.remove(), ha = null)) : (La = -(B - K) / 2 - G, Math.abs(B - K) < Ma && !this.showAllValueLabels && (ha.remove(), ha = null)));
                                break;
                            case "inside":
                                q ? (La = -(Ma / 2) + this.fontSize / 2, Ka = 0 > ea ? Qa / 2 + 6 : -Qa / 2 - 6) : La = 0 > ea ? Ma: -Ma
                            }
                            if (ha) {
                                if (isNaN(ja) || isNaN(ca)) ha.remove(),
                                ha = null;
                                else if (ca += Ka, ja += La, ha.translate(ca, ja), q) {
                                    if (0 > ja || ja > n) ha.remove(),
                                    ha = null
                                } else {
                                    var Sb = 0;
                                    "3d" == V && (Sb = F * L);
                                    if (0 > ca || ca > m + Sb) ha.remove(),
                                    ha = null
                                }
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(v, t, O, P) : this.drawLineGraph(v, t, O, P),
        ba || this.launchAnimation();
    ...
    drawLineGraph: function(a, b, c, d) {
        ...
        if (1 < a.length) {
            ...
            s && (r = s);
            var w = e.dashLength; (s = e.dashLengthSwitched) && (w = s);
            ...
            if (0 < f || 0 < t) if (n = a.join(";").split(";"), q = b.join(";").split(";"), m = g.type, "serial" == m ? 0 < c.length ? (c.reverse(), d.reverse(), n = a.concat(c), q = b.concat(d)) : e.rotate ? (q.push(q[q.length - 1]), n.push(u), q.push(q[0]), n.push(u), q.push(q[0]), n.push(n[0])) : (n.push(n[n.length - 1]), q.push(u), n.push(n[0]), q.push(u), n.push(a[0]), q.push(q[0])) : "xy" == m && (b = e.fillToAxis) && (AmCharts.isString(b) && (b = g.getValueAxisById(b)), "H" == b.orientation ? (u = "top" == b.position ? 0 : b.viH, n.push(n[n.length - 1]), q.push(u), n.push(n[0]), q.push(u), n.push(a[0]), q.push(q[0])) : (u = "left" == b.position ? 0 : b.viW, q.push(q[q.length - 1]), n.push(u), q.push(q[0]), n.push(u), q.push(q[0]), n.push(n[0]))), a = e.gradientRotation, 0 < f && (g = AmCharts.polygon(h, n, q, r, f, 1, "#000", 0, a), g.pattern(e.pattern), k.push(g)), v || void 0 !== s) isNaN(t) && (t = f),
            v || (v = s),
            h = AmCharts.polygon(h, n, q, v, t, 1, "#000", 0, a),
            h.pattern(e.pattern),
            l.push(h),
            l.click(function(a) {
                e.handleGraphEvent(a, "clickGraph")
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    createCursor: function() {
        ...
        this.line = e = AmCharts.line(this.container, e, f, this.cursorColor, b, 1); (f = this.fullRectSet) ? (f.push(e), f.translate(this.x, this.y)) : this.set.push(e);
    ...
    destroy: function() {
        ...
        a && a.destroy(); (a = this.vaBalloon) && a.destroy();
    ...
    setPosition: function(a, b, c) {
        void 0 === b && (b = !0);
        if ("cursor" == this.type) {
            if (this.tempPosition = NaN, AmCharts.ifArray(this.data)) isNaN(a) && (a = this.getMousePosition()),
            (a != this.previousMousePosition || !0 === this.zoomed || this.oneBalloonOnly) && !isNaN(a) && ("mouse" == this.cursorPosition && (this.tempPosition = a), isNaN(c) && (c = this.chart.categoryAxis.xToIndex(a)), c != this.previousIndex || this.zoomed || "mouse" == this.cursorPosition || this.oneBalloonOnly) && (this.updateCursor(c, b), this.zoomed = !1),
            ...
            if (q) {
                ...
                if (c.mouseIsOver || E || A || this.forceShow) if (this.forceShow = !1, A) {
                    ...
                    if (this.oneBalloonOnly) {
                        r = Infinity;
                        for (g = 0; g < z.length; g++) t = z[g],
                        t.showBalloon && !t.hidden && t.balloonText && (u = q.axes[t.valueAxis.id].graphs[t.id], v = u.y, isNaN(v) || (s ? Math.abs(e - v) < r && (r = Math.abs(e - v), H = t) : Math.abs(f - v) < r && (r = Math.abs(f - v), H = t)));
                    ...
                    if (a != this.previousIndex || H != this.previousMostCloseGraph) if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], z && this.valueBalloonsEnabled && w && c.balloon.enabled) {
                        ...
                        for (g = 0; g < z.length; g++) if (t = z[g], v = NaN, (!this.oneBalloonOnly || t == H) && t.showBalloon && !t.hidden && t.balloonText && ("step" == t.type && "left" == t.stepDirection && (q = this.data[a + 1]), q)) {
                            ...
                            if (!isNaN(v)) {
                                ...
                                k && (k = this.graphBulletSize, F = this.graphBulletAlpha, 1 == k && isNaN(F) || !AmCharts.isModern || !(x = u.bulletGraphics) || (x.getBBox(), x.translate(u.bx, u.by, k), this.resizedBullets.push(u), isNaN(F) || (x.setAttr("fill-opacity", F), x.setAttr("stroke-opacity", F))), k = t.valueBalloon, F = c.getBalloonColor(t, u), k.setBounds(l, m, l + n, m + p), k.pointerOrientation = "H", x = this.balloonPointerOrientation, "vertical" == x && (k.pointerOrientation = "V"), "horizontal" == x && (k.pointerOrientation = "H"), k.changeColor(F), void 0 !== t.balloonAlpha && (k.fillAlpha = t.balloonAlpha), void 0 !== t.balloonTextColor && (k.color = t.balloonTextColor), k.setPosition(r + l, d + m), r = c.formatString(t.balloonText, u, !0), (d = t.balloonFunction) && (r = d(u, t).toString()), "" !== r && (s ? k.showBalloon(r) : (k.text = r, k.show = !0), w.push({
                                    yy: v,
                                    balloon: k
                    ...
                    h.index = a, h.chart = this.chart, h.zooming = E, h.mostCloseGraph = H, h.position = s ? f: e, h.target = this, c.fire("changed", h), this.fire("changed", h), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
    ...
    dispatchScrollbarEvent: function() {
        if (this.skipEvent) this.skipEvent = !1;
            ...
            if (h.parseDates && !h.equalSpacing) {
                if (a = g.lastTime, g = g.firstTime, h.minDuration(), h = Math.round(b / k) + g, b = this.dragging ? h + this.timeDifference: Math.round((b + c) / k) + g, h > b && (h = b), 0 < e && b - h < e && (b = Math.round(h + (b - h) / 2), d = Math.round(e / 2), h = b - d, b += d, d = !0), b > a && (b = a), b - e < h && (h = b - e), h < g && (h = g), h + e > b && (b = h + e), h != this.startTime || b != this.endTime) this.startTime = h,
                this.endTime = b,
                f.start = h,
                f.end = b,
                ...
                this.fire(f.type, f)
            } else if (h.startOnAxis || (b += k / 2), c -= this.stepWidth / 2, e = h.xToIndex(b), b = h.xToIndex(b + c), e != this.start || this.end != b) h.startOnAxis && (this.resizingRight && e == b && b++, this.resizingLeft && e == b && (0 < e ? e--:b = 1)),
            this.start = e,
            this.end = this.dragging ? this.start + this.difference: b,
            f.start = this.start,
            f.end = this.end,
            h.parseDates && (a[this.start] && (f.startDate = new Date(a[this.start].time)), a[this.end] && (f.endDate = new Date(a[this.end].time))),
            this.fire(f.type, f);
    ...
    draw: function() {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                u += 2 * s;
                z = x + 2 * r; ! isNaN(A) && z < A && (z = A);
                window.opera && (u += 2);
                var H = !1,
                x = this.offsetY;
                c.handDrawn && (x += c.handDrawScatter + 2);
                "H" != v ? (A = a - z / 2, b < h + u + 10 && "down" != v ? (H = !0, d && (b += x), x = b + w, this.deltaSignY = -1) : (d && (b -= x), x = b - u - w, this.deltaSignY = 1)) : (2 * w > u && (w = u / 2), x = b - u / 2, a < g + (k - g) / 2 ? (A = a + w, this.deltaSignX = -1) : (A = a - z - w, this.deltaSignX = 1));
                x + u >= l && (x = l - u);
                x < h && (x = h);
                A < g && (A = g);
                A + z > k && (A = k - z);
                ...
                G = this.bulletSize,
                V;
                0 < t || 0 === w ? (0 < s && (a = AmCharts.rect(e, z, u, n, 0, r + 1, F, s, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), n = AmCharts.rect(e, z, u, n, this.fillAlpha, r, p, this.borderAlpha, this.cornerRadius), this.showBullet && (V = AmCharts.circle(e, G, q, this.fillAlpha), f.push(V))) : (q = [], t = [], "H" != v ? (g = a - A, g > z - w && (g = z - w), g < w && (g = w), q = [0, g - w, a - A, g + w, z, z, 0, 0], t = H ? [0, 0, b - x, 0, 0, u, u, 0] : [u, u, b - x, u, u, 0, 0, u]) : (q = b - x, q > u - w && (q = u - w), q < w && (q = w), t = [0, q - w, b - x, q + w, u, u, 0, 0], q = a < g + (k - g) / 2 ? [0, 0, A < a ? 0 : a - A, 0, 0, z, z, 0] : [z, z, A + z > a ? z: a - A, z, z, 0, 0, z]), 0 < s && (a = AmCharts.polygon(e, q, t, n, 0, r, F, s), a.translate(1, 1), f.push(a)), n = AmCharts.polygon(e, q, t, n, this.fillAlpha, r, p, this.borderAlpha));
                this.bg = n;
                f.push(n);
                n.toFront();
                e = 1 * this.deltaSignX;
    ...
    parseSerialData: function() {
        ...
        if (e) {
            ...
            for (s = 0; s < e.length; s++) {
                ...
                l && (t.labelColor = u[l]);
                r[u[d]] = t;
                if (f && (b = h.categoryFunction ? h.categoryFunction(b, u, h) : b instanceof Date ? AmCharts.newDate(b, h.minPeriod) : w ? AmCharts.stringToDate(b, w) : new Date(b), b = AmCharts.resetDateToMin(b, m, n, h.firstDayOfWeek), t.category = b, t.time = b.getTime(), isNaN(t.time))) continue;
                ...
                for (E = 0; E < x.length; E++) {
                    ...
                    for (z = 0; z < a.length; z++) {
                        ...
                        if (b.valueAxis.id == A) {
                            ...
                            var V = u;
                            b.dataProvider && (V = c);
                            G.values = this.processValues(V, b, F); ! b.connect && v && v[H] && t.time - p[H] > 1.1 * q && (v[H].gap = !0);
...
AmCharts.AmSlicedChart = AmCharts.Class({
    ...
    pullSlice: function(a, b, c) {
        var d = this.pullOutDuration; ! 0 === c && (d = 0); (c = a.wedge) && (0 < d ? c.animate({
...
AmCharts.AmRectangularChart = AmCharts.Class({
    ...
    drawPlotArea: function() {
        ...
        g.translate(c + a, d + b);
        this.set.push(g);
        0 !== a && 0 !== b && (g = this.plotAreaFillColors, "object" == typeof g && (g = g[0]), g = AmCharts.adjustLuminosity(g, -.15), e = AmCharts.polygon(this.container, [0, a, e + a, e, 0], [0, b, b, 0, 0], g, h, 1, k, l), e.translate(c, d + f), this.set.push(e), a = AmCharts.polygon(this.container, [0, 0, a, a, 0], [0, f, f + b, b, 0], g, h, 1, k, l), a.translate(c, d), this.set.push(a)); (c = this.bbset) && this.scrollbarOnly && c.remove()
    },
...
AmCharts.TrendLine = AmCharts.Class({
    ...
    draw: function() {
        ...
        isNaN(d) || isNaN(e) || isNaN(f) || isNaN(f) || (b.rotate ? (h = [f, g], e = [d, e]) : (h = [d, e], e = [f, g]), f = a.lineColor, d = AmCharts.line(c, h, e, f, a.lineAlpha, a.lineThickness, a.dashLength), g = h, k = e, n = h[1] - h[0], p = e[1] - e[0], 0 === n && (n = .01), 0 === p && (p = .01), l = n / Math.abs(n), m = p / Math.abs(p), p = n * p / Math.abs(n * p) * Math.sqrt(Math.pow(n, 2) + Math.pow(p, 2)), n = Math.asin(n / p), p = 90 * Math.PI / 180 - n, n = Math.abs(5 * Math.cos(p)), p = Math.abs(5 * Math.sin(p)), g.push(h[1] - l * p, h[0] - l * p), k.push(e[1] + m * n, e[0] + m * n), h = AmCharts.polygon(c, g, k, f, .005, 0), c = c.set([h, d]), c.translate(b.marginLeftReal, b.marginTopReal), b.trendLinesSet.push(c), a.line = d, a.set = c, h.mouseup(function() {
            a.handleLineClick()
        }).mouseover(function() {
            a.handleLineOver()
        }).mouseout(function() {
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    0 < k && (G = " M" + s + "," + (v + k) + " L" + t + "," + (u + k), r ? (F || (G += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + t + "," + (u + k) + "," + x + "," + (E + k)), G += " L" + A + "," + (w + k), 0 < h && (F || (G += " B" + (b - h) + "," + (k + c - q) + "," + (b + h) + "," + (k + c + q) + "," + A + "," + (k + w) + "," + s + "," + (k + v)))) : (G += " A" + f + "," + g + ",0," + H + ",1," + x + "," + (E + k) + " L" + A + "," + (w + k), 0 < h && (G += " A" + h + "," + q + ",0," + H + ",0," + s + "," + (v + k))), G = a.path(G + " Z", void 0, void 0, "1000,1000").attr(z), d.push(G), G = a.path(" M" + s + "," + v + " L" + s + "," + (v + k) + " L" + t + "," + (u + k) + " L" + t + "," + u + " L" + s + "," + v + " Z", void 0, void 0, "1000,1000").attr(z), k = a.path(" M" + x + "," + E + " L" + x + "," + (E + k) + " L" + A + "," + (w + k) + " L" + A + "," + w + " L" + x + "," + E + " Z", void 0, void 0, "1000,1000").attr(z), d.push(G), d.push(k));
    r ? (F || (e = " A" + p(b - f) + "," + p(c - g) + "," + p(b + f) + "," + p(c + g) + "," + p(t) + "," + p(u) + "," + p(x) + "," + p(E)), f = " M" + p(s) + "," + p(v) + " L" + p(t) + "," + p(u) + e + " L" + p(A) + "," + p(w)) : f = " M" + s + "," + v + " L" + t + "," + u + (" A" + f + "," + g + ",0," + H + ",1," + x + "," + E) + " L" + A + "," + w;
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    drawLegend: function() {
        ...
        this.divWidth = k; (b = this.container) ? (b.container.innerHTML = "", f.appendChild(b.container), b.setSize(k, e)) : b = new AmCharts.AmDraw(f, k, e, a);
        this.container = b;
        this.lx = 0;
        this.ly = 8;
        e = this.markerSize;
        ...
        this.titleWidth = 0;
        if (e = this.title) a = AmCharts.text(this.container, e, this.color, a.fontFamily, this.fontSize, "start", !0),
    ...
    arrangeEntries: function() {
        ...
        for (t = 0; t < w.length; t++) {
            ...
            z.translate(H, E);
            u++; ! isNaN(k) && u >= k && (u = 0, q++, E = E + A + l, A = 0);
            r.push(z)
        }
        v = r.getBBox();
        k = v.height + 2 * l - 1;
    ...
    createEntry: function(a) {
        if (!1 !== a.visibleInLegend) {
            ...
            n = l / 3;
                ...
                if (g = this.createMarker("rectangle", m, a.fillAlphas, a.lineThickness, d, a.lineAlpha, q, g)) p = l,
                g.translate(p, l / 2);
                m = l
            ...
            k = k.set([g]);
            this.switchable && a.switchable && k.setAttr("cursor", "pointer"); (f = this.switchType) && "none" != f && ("x" == f ? (q = this.createX(), q.translate(l / 2, l / 2)) : q = this.createV(), q.dItem = a, !0 !== a.hidden ? "x" == f ? q.hide() : q.show() : "x" != f && q.hide(), this.switchable || q.hide(), this.addListeners(q, a), a.legendSwitch = q, k.push(q));
            f = this.color;
            ...
            var r;
            d && (d = AmCharts.fixBrakes(d), a.legendTextReal = d, r = this.labelWidth, r = isNaN(r) ? AmCharts.text(this.container, d, f, b.fontFamily, q, "start") : AmCharts.wrappedText(this.container, d, f, b.fontFamily, q, "start", !1, r, 0), r.translate(this.lx + m, this.ly), k.push(r), b = r.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
