...
<html lang="zh">
	...
	<body>
		<ul class="breadcrumb" style="margin-bottom: 5px;">
			...
			<li>
				<a href="/jksqgz/list/1">健康社区工作统计表</a>
				<span class="divider">/</span>
			</li>
			<li class="active">
				新增表单
		...
		<div class="mianpan">
			<div class="panhead">
				<i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong>			健康社区工作统计表
			</div>
			<div id="panbody">
				<div class="container">
					<form action="/jksqgz/add" method="post">
	...
	$(function() {
		var myDate = new Date();
		$('#name').val('健康社区工作统计表(' + myDate.getFullYear() + ')');
