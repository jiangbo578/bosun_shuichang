...
<body>
	<ul class="breadcrumb" style="margin-bottom: 5px;">
	    ...
	    <li class="active">土地管理日常巡查记录</li>
  </ul>
			
	<div class="mianpan">
		  <div class="panhead">
		  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 土地管理日常巡查记录
		  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="tdglrc:add">
						<a  style="margin-bottom: 5px" href="/tdglrc/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
							...
							<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="tdglrc:update">
											...
											<a class="btn " href="/tdglrc/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="tdglrc:delete">
											<a class="btn  b_delete_" href="/tdglrc/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/tdglrc/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="tdglrc:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/tdglrc/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
