...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 共建、创建、联建单位名单</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/gcldw/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>联系人：</th>
					<td><input name="lxr" type="text" data-rule="required;" id="lxr"/>
					</td>
				</tr>
				<tr>
					<th>单位名称：</th>
					<td><input name="dwname" type="text"  data-rule="required;"  id="dwname" />
					</td>
				</tr>
					<tr>
					<th>地址：</th>
					...
					<tr>
					<th>单位性质：</th>
					<td><input name="dwxz" type="text" id="dwxz" data-rule="required" />
					</td>
				</tr>
				<tr>
					<th>联系电话：</th>
