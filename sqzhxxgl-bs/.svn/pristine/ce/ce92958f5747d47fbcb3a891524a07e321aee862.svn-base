...
<body>
 ...
 <li><a href="/taizhang/list/3">公共服务</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 独居老人名册</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/djlr/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>年龄：</th>
					<td><input name="age" type="text" id="age" data-rule="required;number"/>
					</td>
				</tr>
				<tr>
					<th>住址：</th>
				...
				<tr>
					<th>联系人：</th>
					<td><input name="lxr" type="text" id="lxr" data-rule="required"/>
					</td>
				</tr>	
