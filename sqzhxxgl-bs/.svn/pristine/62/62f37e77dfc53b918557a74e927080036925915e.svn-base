...
<body>
    ...
    <li ><a href="/wmjianshe/list/1">社区（家庭）文明建设活动情况</a> <span class="divider">/</span></li>
    <li class="active">修改表单名称</li>
  </ul>
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>表单名称编辑</strong> 社区（家庭）文明建设活动情况</div>
  <div id="panbody">
	<div class="container">
		<form  action="/wmjianshe/update" method="post">
