...
<div class="mianpan">
  ...
  <div id="panbody">
	<div class="container" >
		  ...
		  <shiro:hasPermission name="peoplesummary:add">
		  <c:if test="${fn:length(datas)==0}">
		  <a style="float: right" href="/peoplesummary/item/add/${businessFormId}" class="btn btn-success "><i class="icon-plus"></i>添加记录</a>
		  </c:if>
		  </shiro:hasPermission>
        <a style="float: right;margin-right: 31px;padding-left: 10px" href="/peoplesummary/export/${businessFormId }" class="btn btn-info"><i class="icon-print"></i>导出</a>
	   <shiro:hasPermission name="peoplesummary:add">
	    <a style="float: right;margin-right: 31px;padding-left: 10px"  class="btn btn-info" href="/peoplesummary/list/1"><i class="icon-share-alt"></i> 返回</a>
		</shiro:hasPermission>
		<table class="table table-striped table-bordered table-hover" style="margin-top: 10px">
			<tbody>
				<c:forEach items="${datas }" var="peoplesummary" varStatus="num">
					...
					<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~tr start~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
					 <tr >
					  ...
					  <tr >
					    ...
					    <td width="46" valign="center" colspan="2" ><p >${peoplesummary.mzdprs} </p></td>
					...
					<td>
							<div class="btn-group">
							<shiro:hasPermission name="peoplesummary:update">
							<a  class="btn " href="/peoplesummary/item/update/${peoplesummary.id}/${businessFormId }"><i class="icon-pencil"></i>修改</a>
							</shiro:hasPermission>
							<shiro:hasPermission name="peoplesummary:delete">
							<a class="btn  b_delete_item" href="/peoplesummary/item/delete/${peoplesummary.id }/${businessFormId }" ><i class="icon-trash"></i>删除</a>
						</shiro:hasPermission>
						</div>
						</td>
						 <td width="79" valign="center" colspan="3" ><p > </p></td>
					    <td width="153" valign="center" colspan="8" ></td>
					    <td width="86" valign="center" colspan="8" ><p > </p></td>
					    <td width="211" valign="center" colspan="14" ><p > </p></td>
					</tr>
				</c:forEach>
			</tbody>
	...
	<script>
		$(function() {
			...
			var pagination = new buguPagination('${current}',
					'${pages}', '${count}', '/peoplesummary/item/', '/${businessFormId }');
