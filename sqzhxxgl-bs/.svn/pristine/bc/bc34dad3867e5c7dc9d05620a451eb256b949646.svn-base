...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 业主委员会成员名单</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/yzwyh/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>职务：</th>
					<td><input name="role" type="text"  data-rule="required;chinese;"/>
					</td>
				</tr>
				<tr>
					<th>出生年月：</th>
					<td><input name="birthday" type="text" data-rule="required:date;" onClick="WdatePicker()"  class="Wdate" />
					</td>
				</tr>
				<tr>
					<th>文化程度：</th>
					<td><input name="degree" type="text"  data-rule="required;chinese;"/>
					</td>
				</tr>
				<tr>
					<th>政治面貌：</th>
					<td><input name="status" type="text" data-rule="required;chinese;"/>
					</td>
				</tr>
				<tr>
					<th>家庭住址：</th>
