...
<body>
    ...
    <li class="active">社区优秀女性名册</li><!--
    <li /excellentwoman/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 社区优秀女性名册
  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="excellentwoman:add">
						<a  style="margin-bottom: 5px" href="/excellentwoman/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						
					</shiro:hasPermission>
					<a style="margin-bottom: 5px"  class="btn btn-info" href="/taizhang/list/4/${userRoleCode}"><i class="icon-share-alt"></i> 返回</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="excellentwoman:update">
											...
											<a class="btn " href="/excellentwoman/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="excellentwoman:delete">
											<a class="btn  b_delete_" href="/excellentwoman/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/excellentwoman/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="excellentwoman:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/excellentwoman/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
