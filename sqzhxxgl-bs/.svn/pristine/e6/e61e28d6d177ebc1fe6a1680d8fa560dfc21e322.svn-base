...
public class XfqcwhController extends PageableController {
	...
	public String toIndex() {
		return "redirect:/xfqcwh/1";
	}

	@RequestMapping(value = "/{current}", method = RequestMethod.GET)
	public String index(Model model, @PathVariable() int current) {
		Business business = businessService.findOneByCode("Xfqcwh");
		...
		return "/business/xfqcwh/index";
	}
	
	@RequestMapping(value = "/add", method = RequestMethod.GET)
	public String toAdd() {
		return "/business/xfqcwh/add";
	}
