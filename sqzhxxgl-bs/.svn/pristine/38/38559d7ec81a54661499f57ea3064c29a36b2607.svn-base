...
<body>
  <ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li class="active">添加</li>
				...
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 红十字服务站帮困救助情况记录</div>
  <div id="panbody">
	<div class="container">
	
	
	
		<form action="/hszfwzbk/item/add" method="post">
		 ...
		 <tr>
				...
				<tr>
					<th>出生年月：</th>
					<td><input name="birthday" id="birthday" type="text"  onClick="WdatePicker()" class="Wdate" data-rule="required;date"/>
					</td>
				</tr>
				<tr>
					<th>救助时间：</th>
					<td><input name="jzsj" type="text"  onClick="WdatePicker()" class="Wdate" data-rule="required;date"/>
					</td>
				</tr>
				<tr>
					<th>住址：</th>
					<td><input name="address"  id="address"  type="text"  data-rule="required;"/>
					</td>
				</tr>
				<tr>
					<th>联系电话：</th>
				...
				<tr>
					<th>帮困金额：</th>
					<td><input name="bkjr" type="text" data-rule="required;number"/>
					</td>
				</tr>
				<tr>
					<th>备注：</th>
