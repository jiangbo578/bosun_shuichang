...
<body>
   ...
   <li><a href="/taizhang/list/3">公共服务</a> <span class="divider">/</span></li>
    ...
    <li class="active">新增表</li>
			...
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 低保及一户多残残疾人家庭名册</div>
  <div id="panbody">
	<div class="container">
		<form  action="/cjrjt/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('低保及一户多残残疾人家庭名册('+myDate.getFullYear()+')');
