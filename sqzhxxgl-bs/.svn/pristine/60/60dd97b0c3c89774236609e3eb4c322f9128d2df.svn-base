...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
    ...
    <li class="active">添加</li>
				...
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 居住在本居民区的在职党员概况名册</div>
  <div id="panbody">
	<div class="container">
		<form action="/zzdygk/item/add" method="post">
			<table><%--
				<tr>
				...
				<tr>
					<th>性别：</th>
					<td><input name="xb" type="radio" value="男性" checked="checked"/>男 <input name="xb" type="radio" value="女性" />女
					</td>
				</tr>
				<tr>
					<th>出生年月：</th>
				...
				<tr>
					<th>工作单位：</th>
					<td><input name="workUnit" type="text"  data-rule="required;length[1~20];"/>
					</td>
				</tr>
				<tr>
					<th>联系电话：</th>
				...
				<tr>
					<th>党员类型：</th>
					<td><input name="type" type="radio" value="正式党员" checked="checked"/>正式党员 <input name="register" type="radio" value="预备党员" />预备党员
					</td>
				</tr>
				<tr>
					<th>报到情况：</th>
				...
				<tr>
					<th>特长情况：</th>
					<td><textarea name="tc" style="width:300px;height:200px;"  data-rule="required;length[1~50];" ></textarea>
					</td>
				</tr>
				<tr>
					<th>&nbsp;</th>
