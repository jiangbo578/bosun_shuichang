...
<body>
  <ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li><a href="/hszfwzhy/list/1">学习型社区建设</a> <span class="divider">/</span></li>
  ...
  <div id="panbody">
	<div class="container">
		...
		<form action="/hszfwzhy/item/add" method="post">
			...
			<table>
				...
				<tr>
					...
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" id="birthday"  data-rule="required;date;"/>
					</td>
				</tr>
				...
				<tr>
					...
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" id="djsj" />
					</td>
				</tr>
