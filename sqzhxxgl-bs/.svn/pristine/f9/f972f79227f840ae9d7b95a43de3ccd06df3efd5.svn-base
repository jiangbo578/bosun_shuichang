...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
  ...
  <div id="panbody">
	<div class="container">
		<form action="/fcbkjd/item/update" method="post">

			<table>
				<tr>
					<th>党员干部姓名：</th>
					<td><input name="gbxm" type="text"  id="name" data-rule="required" value="${fcbkjd.gbxm}"/>
					</td>
				</tr>
				<tr>
					<th>职务：</th>
					<td><input name="role" type="text"  id="name" data-rule="required" value="${fcbkjd.role}"/>
					</td>
				</tr>
				<tr>
					<th>结对时间：</th>
					<td><input name="jdsj" type="text" data-rule="required;date" 
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" id="jdsj" value="${fcbkjd.jdsj}"/>
					</td>
				</tr>
				<tr>
					<th>结对对象姓名：</th>
					<td><input name="jdxm" type="text" id="dwtr" data-rule="required" value="${fcbkjd.jdxm}"/>
					</td>
				</tr>
				<tr>
					<th>残疾类别：</th>
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$("#cjlb option[value='${fcbkjd.cjlb}']").attr("selected", true);
	</script>
</body>
</html>