...
<body>
	<ul class="breadcrumb" style="margin-bottom: 5px;">
	    ...
	    <li class="active">行政村平面图</li>
  </ul>
			
	<div class="mianpan">
		  <div class="panhead">
		  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong>行政村平面图
		  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="xzpmt:add">
						<a  style="margin-bottom: 5px" href="/xzpmt/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
							...
							<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="xzpmt:update">
											...
											<a class="btn " href="/xzpmt/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="xzpmt:delete">
											<a class="btn  b_delete_" href="/xzpmt/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> 
										<a class="btn " href="/xzpmt/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	<script>
		$(function() {
			//分页
			var pagination = new buguPagination('${current}','${pages}', '${count}', '/xzxzpmt/list/');
