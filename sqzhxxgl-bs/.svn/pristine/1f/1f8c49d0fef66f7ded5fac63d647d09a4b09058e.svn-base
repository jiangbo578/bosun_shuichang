...
<body>
 ...
 <li><a href="/taizhang/list/4">党群工作</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
	  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong>小区侨眷名单</div>
	  <div id="panbody">
		<div class="container">
	
		<form action="/qjrs/item/add" method="post">
			...
			<table>
				...
				<tr>
					<th>民族：</th>
					<td><input name="mz" type="text" id="mz" data-rule="required;" data-rule="required;length[1~10];"/>
					</td>
				</tr>
				<tr>
					<th>住址：</th>
				...
				<tr>
					<th>侨眷关系：</th>
					<td><input name="relation" type="text"   data-rule="required;length[1~10];" ></input>
					</td>
				</tr>
				<tr>
					<th>华侨居住国：</th>
