...
<body>
  ...
  <div id="panbody">
	<div class="container">
		<form action="/lnxx/item/head/update" method="post">
 <table>
        <tr>
					<th>学校名称：</th>
					<td><input name="xxmc" type="text" data-rule="required;" value="${lnxx.xxmc}"/>
				...
				<tr>
					<th >建立时间：</th>
					<td><input name="jlsj" type="text" data-rule="required;date" 
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" id="jlsj" value="${lnxx.jlsj}"/>
					</td>
				</tr>
         </table>
					...
					<input type="hidden" name="id" value="${lnxx.id}">
					</td>
				</tr>
