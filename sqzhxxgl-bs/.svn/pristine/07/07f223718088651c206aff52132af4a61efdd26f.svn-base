...
<body>
  <ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li class="active">添加</li>
				...
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 不规范生猪养殖场（户）整治推进情况统计 </div>
  <div id="panbody">
	<div class="container">
	
	
	
		<form action="/bgfyzc/item/add" method="post">
            <table> 
		       
				<tr>
					<th>养殖户：</th>
					<td><input name="yzh" type="text" data-rule="required;" />
					</td>
				</tr>
				<tr>
					<th>新 增：</th>
			...
			<!-- 	<tr>
				...
				<tr>
					<th>养殖地点：</th>
					<td><input name="yzdd" type="text" data-rule="required;length[1~20];"/>
					</td>
				</tr>
				<tr>
					<th>联系电话：</th>
					<td><input type="text" name="phone"  data-rule="required;"/>
					</td>
				</tr>
				<tr>
					<th>公猪：</th>
					<td><input type="text" name="gz"  data-rule="required;digits;"/>
					</td>
				</tr>
				<tr>
					<th>母猪：</th>
					<td><input name="mz" type="text" data-rule="required;digits;" />
					</td>
				</tr>
				<tr>
					<th>商品肉猪：</th>
					<td><input name="sprz" type="text" data-rule="required;digits;" />
					</td>
				</tr>
