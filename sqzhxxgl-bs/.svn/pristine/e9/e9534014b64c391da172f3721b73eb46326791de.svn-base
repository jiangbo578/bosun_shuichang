...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
    ...
    <li><a href="/tsjbzx/list/1">党员组织关系转入</a> <span class="divider">/</span></li>
    <li class="active">添加</li>
  </ul>
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 党员组织关系转入</div>
  <div id="panbody">
	<div class="container">
		<form action="/dyzzgxzr/item/add" method="post">
			<table>
				<!-- <tr>
				...
				<tr>
					...
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" id="zrrq"/>
					</td>
				</tr>
				<tr>
					<th>由何单位调入：</th>
					<td><input name="dwtr" type="text" id="dwtr"   data-rule="required;length[1~20];" />
					</td>
				</tr>
				<tr>
					<th>是否正式党员：</th>
