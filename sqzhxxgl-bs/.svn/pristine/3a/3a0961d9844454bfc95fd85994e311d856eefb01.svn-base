...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
    ...
    <li><a href="/tsjbzx/list/1">妇女教育培训情况</a> <span class="divider">/</span></li>
    <li class="active">添加</li>
  </ul>
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 妇女教育培训情况</div>
  <div id="panbody">
	<div class="container">
		<form action="/educationtrain/item/add" method="post">
			<table>
				...
				<tr>
					<th>活动效果：</th>
					<td><input name="result" type="text" id="mz" data-rule="required;" data-rule="required;length[1~30];"/>
					</td>
				</tr>
