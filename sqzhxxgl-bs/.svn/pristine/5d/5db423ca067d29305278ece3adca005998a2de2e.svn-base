...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>妇女教育培训情况</strong></div>
  <div id="panbody">
	<div class="container">
		<table class="table table-striped table-bordered table-hover">
			...
			<tr>
				<th>审核</th>
				<td>
				<form action="/educationtrain/check" method="post">
	...
	<script>
		$(function() {
			...
			var pagination = new buguPagination('${current}',
					'${pages}', '${count}', '/educationtrain/check/', '/${businessFormId }');
