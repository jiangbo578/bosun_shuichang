...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
    ...
    <li ><a href="/dyzzgxzc/list/1">社区（家庭）文明建设活动</a> <span class="divider">/</span></li>
	...
	<div class="container">
		<table class="table table-striped table-bordered table-hover">
			...
			<tr>
				<th>审核</th>
				<td>
				<form action="/dyzzgxzc/check" method="post">
	...
	<script>
		$(function() {
			...
			var pagination = new buguPagination('${current}',
					'${pages}', '${count}', '/dyzzgxzc/check/', '/${businessFormId }');
