...
<body>
    ...
    <li class="active">工业企业基本信息</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i>工业企业基本信息
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="gyqyjbxx:add">
						<a  style="margin-bottom: 5px" href="/gyqyjbxx/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						
					</shiro:hasPermission>
					<a style="margin-bottom: 5px"  class="btn btn-info" href="/taizhang/list/2/${userRoleCode}"><i class="icon-share-alt"></i> 返回</a>
					<!-- <a href="#" class="tjBtn">提交审核</a> -->
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<td>
									<div class="btn-group">
									<shiro:hasPermission name="gyqyjbxx:update">
											
											
											<a class="btn " href="/gyqyjbxx/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="gyqyjbxx:delete">
											<a class="btn  b_delete_zcdygk" href="/gyqyjbxx/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/gyqyjbxx/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="gyqyjbxx:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_gyqyjbxx" href="/gyqyjbxx/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	<script>
		$(function() {
			...
			$('.b_submit_gyqyjbxx').on('click', function() {
