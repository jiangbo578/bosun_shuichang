...
<body>
    ...
    <li ><a href="/ndfzdx/list/1">开展党员志愿者服务活动情况</a> <span class="divider">/</span></li>
    <li class="active">新增表</li>
  </ul>
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong>开展党员志愿者服务活动情况</div>
  <div id="panbody">
	<div class="container">
		<form  action="/ndfzdx/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('开展党员志愿者服务活动情况('+myDate.getFullYear()+')');
