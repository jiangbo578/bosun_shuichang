...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据修改</strong>工作计划</div>
  <div id="panbody">
	<div class="container">
		<form action="/gzjh/item/update" method="post">

			<table>
				<tr>
					<th>内容：</th>
					<td>
						<textarea name="nr" id="b_create_kindeditor" style="width:700px;height:350px;">${gzjh.nr}</textarea>
					</td>
				</tr>
				<tr>
					<th>类型：</th>
				...
				<tr>
					<th>记录人：</th>
					<td><input name="jlr" type="text"  id="jlr" data-rule="required" value="${gzjh.jlr}"/>
					</td>
				</tr>
			...
			<tr>
				...
				<button  class="btn btn-info" type="button" onclick="window.history.go(-1)" ><i class="icon-share-alt"></i> 返回</button>
					...
					<input type="hidden" name="id" value="${gzjh.id}">
					</td>
				</tr>
			</table>
		</form>
...
$("#type option[value='${gzjh.type}']").attr("selected", true);
