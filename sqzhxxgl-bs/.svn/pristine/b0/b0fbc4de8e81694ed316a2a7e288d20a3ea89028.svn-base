...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>优抚对象临时性困难补助情况登记表</strong></div>
  <div id="panbody">
	<div class="container">
		<table class="table table-striped table-bordered table-hover">
			...
			<td>
				...
				<tbody>
					<c:forEach items="${datas}" var="mzdp" varStatus="num">
						<tr>
							<td>${num.count }</td>
						    <td>${mzdp.xm}</td>
						    <td>${mzdp.xb}</td>
			...
			<tr>
				<th>审核</th>
				<td>
				<form action="/allowance/check" method="post">
	...
	<script>
		$(function() {
			...
			var pagination = new buguPagination('${current}',
					'${pages}', '${count}', '/allowance/check/', '/${businessFormId }');
