...
<body>
    ...
    <li class="active">卫生经费使用情况</li><!--
    <li /tsjbzx/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i>卫生经费使用情况
			...
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="wsjf:add">
						<a  style="margin-bottom: 5px" href="/wsjf/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="wsjf:update">
											...
											<a class="btn " href="/wsjf/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="wsjf:delete">
											<a class="btn  b_delete_zcdygk" href="/wsjf/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/wsjf/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="wsjf:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			                              <a class="btn b_submit_xfqcwh" href="/wsjf/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
