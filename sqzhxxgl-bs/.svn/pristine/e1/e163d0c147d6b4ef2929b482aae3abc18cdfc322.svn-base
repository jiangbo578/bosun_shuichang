...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
    ...
    <li class="active">添加</li>
				...
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 在册党员概况及名册</div>
  <div id="panbody">
	<div class="container">
		<form action="/zcdygk/item/add" method="post">
			<table>
			<tr>
				...
				<tr>
					...
					onClick="WdatePicker({dateFmt:'yyyy-MM'})" class="Wdate"/>
					</td>
				</tr>
				<tr>
					<th>备注：</th>
					<td><textarea name="bz" style="width:300px;height:80px;" ></textarea>
					</td>
				</tr>
				<tr>
					<th>&nbsp;</th>
...
<script type="text/javascript" src="../../../../../scripts/business/zcdygk.js"></script>
