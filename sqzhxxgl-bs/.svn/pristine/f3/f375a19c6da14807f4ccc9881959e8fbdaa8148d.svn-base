...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
	...
	<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据修改</strong>行政村平面图</div>
  <div id="panbody">
	<div class="container">
	
					<textarea rows=""  name="enews.contrnt"  id="myEditor" cols="">${pmt.bz}</textarea>
			<table>
