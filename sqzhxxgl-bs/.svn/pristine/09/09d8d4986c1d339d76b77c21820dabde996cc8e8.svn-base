...
<body>
 ...
 <li><a href="/centent"><i class="icon-home"></i>首页</a> <span class="divider">/</span></li>
    ...
    <li class="active">添加</li>
				...
				<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>数据添加</strong> 街镇助学结对统计表（个人版）</div>
  <div id="panbody">
	<div class="container">
		<form action="/zxtjbgrb/item/add" method="post">
			<table>
				<tr>
					<th>姓名：</th>
				...
				<tr>
					<th>政治面貌：</th>
					<td><input name="zzmm" type="text" id="jtzz"/>
					</td>
				</tr>
				<tr>
					<th>工作单位：</th>
					<td><input name="gzdw" type="text" id="jtzz"/>
					</td>
				</tr>
				<tr>
					<th>工作职务：</th>
					<td><input name="role" type="text" id="jtzz"/>
					</td>
				</tr>
				<tr>
					<th>所属街镇：</th>
