...
<body>
    ...
    <li class="active">管辖范围</li><!--
    <li /gxfw/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			
	<div class="mianpan">
		  <div class="panhead">
		  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 管辖范围
		  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
			
					<shiro:hasPermission name="gxfw:add">
						<a  style="margin-bottom: 5px" href="/gxfw/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
					...
					<!-- <a href="#" class="tjBtn">提交审核</a> -->
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<td>
									<div class="btn-group">
									<shiro:hasPermission name="gxfw:update">
											
											
											<a class="btn " href="/gxfw/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="gxfw:delete">
											<a class="btn  b_delete_" href="/gxfw/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/gxfw/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="gxfw:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/gxfw/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
