...
<body>
	<ul class="breadcrumb" style="margin-bottom: 5px;">
	    ...
	    <li><a href="/taizhang/list/3">公共服务</a> <span class="divider">/</span></li>></li>
	    <li class="active">残疾人协会基本情况</li>
  </ul>
			
	<div class="mianpan">
		  <div class="panhead">
		  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong>残疾人协会基本情况
		  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="cjrjbqk:add">
						<a  style="margin-bottom: 5px" href="/cjrjbqk/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
							...
							<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="cjrjbqk:update">
											...
											<a class="btn " href="/cjrjbqk/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="cjrjbqk:delete">
											<a class="btn  b_delete_" href="/cjrjbqk/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/cjrjbqk/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="cjrjbqk:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/cjrjbqk/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
