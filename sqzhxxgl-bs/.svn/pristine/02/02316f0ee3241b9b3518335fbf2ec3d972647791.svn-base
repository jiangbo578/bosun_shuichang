...
<ul class="breadcrumb" style="margin-bottom: 5px;">
  ...
  <div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i><strong>权限列表添加</strong> 
	...
	<div class="container">
		<form action="/authority/add" method="post">
			...
			<table>
				...
				<tr>
					<th>标识：</th>
					<td><input name="code" type="text" data-rule="required;" style="width: 200px"/>
					</td>
				</tr>
				<tr>
					<th>功能链接：</th>
					<td><input name="path" type="text" data-rule="required;" style="width: 200px"/>
					</td>
				</tr>
				<tr>
					<th>描述：</th>
