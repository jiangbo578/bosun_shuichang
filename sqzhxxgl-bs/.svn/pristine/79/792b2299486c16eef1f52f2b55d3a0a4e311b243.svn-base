...
<body>
    ...
    <li class="active">新增表</li>
			...
			<div class="mianpan">
  <div class="panhead"><i class="icon-list">&nbsp;&nbsp;</i><strong>新增表单名称</strong> 为退休和生活困难妇女安排妇科病、乳腺病筛查工作统计表</div>
  <div id="panbody">
	<div class="container">
		<form  action="/womanbsctj/add" method="post">
...
<jsp:include page="/page/footer.jsp"></jsp:include>
	...
	$(function(){
		var myDate = new Date();
		$('#name').val('为退休和生活困难妇女安排妇科病、乳腺病筛查工作统计表('+myDate.getFullYear()+')');
