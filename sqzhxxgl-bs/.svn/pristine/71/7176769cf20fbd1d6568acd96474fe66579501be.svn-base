...
<div  style="overflow:scroll;width:30%; height:400px;float: left;" >
		...
		<div id="" class="alert alert-danger"><i class="icon-list"></i>已选择表：<strong id="checkCount"></strong></div>
		 <form action="/mould/update" method="post" id="downdoc">
		<table>
		  <tr>
			    <th height="28" ><p >模版名称：</p></th>
			    <td ><input type="text"  id="mould_name" data-rule="required"  name="mould_name" value="${mould.mould_name}"/></td>
			  </tr>
			  <tr>
			    <th height="29"><p >使用部门：</p></th>
			    <td ><input type="text"  id="department"  data-rule="required" name="department" value="${mould.department}"/></td>
			  </tr>
			   <tr>
			    <th height="29"><p >备注：</p></th>
			    <td ><input type="text"  id="remark"  data-rule="required" name="remark" value="${mould.remark}"/></td>
			  </tr>
			  <tr>
			   <tr>
			    <td height="29"></td>
			...
			<input type="hidden" name='id' id="id" value="${mould.id}" />
	 </form>
		<br>
