...
<body>
  ...
  <div id="panbody">
	<div class="container">
		<form action="/tyssqclb/item/update" method="post">

		<table id="tab">
					<tr>
					<th>设施名称：</th>
					<td><input name="lb" type="text" data-rule="required;" value="${tyssqclb.lb}"/>
				...
				<tr>
				<th>地址：</th>
					<td><input name="address" type="text" data-rule="required;"  value="${tyssqclb.address}"/>
					</td>
				</tr>
			</table>
					<th>&nbsp;</th>
					...
					<input type="hidden" name="id" value="${tyssqclb.id}">
					</td>
				</tr>
