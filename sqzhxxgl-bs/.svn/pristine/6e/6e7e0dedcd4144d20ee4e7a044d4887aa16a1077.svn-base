...
<body>
	<ul class="breadcrumb" style="margin-bottom: 5px;">
	    ...
	    <li class="active">党员干部扶残帮困结对记录</li>
  </ul>
			
	<div class="mianpan">
		  <div class="panhead">
		  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong>党员干部扶残帮困结对记录
		  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="fcbkjd:add">
						<a  style="margin-bottom: 5px" href="/fcbkjd/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
							...
							<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="fcbkjd:update">
											...
											<a class="btn " href="/fcbkjd/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="fcbkjd:delete">
											<a class="btn  b_delete_" href="/fcbkjd/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/fcbkjd/item/${businessForm.id }"><i class=" icon-folder-open"></i>查看与编辑</a>
										<shiro:hasPermission name="fcbkjd:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/fcbkjd/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
