...
<body>
    ...
    <li class="active">为退休和生活困难妇女安排妇科病、乳腺病筛查工作统计表</li><!--
    <li /womanbsctj/list/1 class="active">投诉举报咨询台账目录</li>-->
  </ul>
			<div class="mianpan">
  <div class="panhead">
  <i class="icon-list">&nbsp;&nbsp;</i><strong>数据列表</strong> 为退休和生活困难妇女安排妇科病、乳腺病筛查工作统计表
  </div>
				<!--add end of-->
			<div class="container" >
				<!--place end of-->
					...
					<shiro:hasPermission name="womanbsctj:add">
						<a  style="margin-bottom: 5px" href="/womanbsctj/add" class="btn btn-success"><i class="icon-plus"></i>新增表单</a>
						...
						<tbody>
								...
								<tr class="bgColor">
									...
									<shiro:hasPermission name="womanbsctj:update">
											...
											<a class="btn " href="/womanbsctj/update/${businessForm.id }"><i class="icon-pencil"></i>修改</a>
											
										</shiro:hasPermission> <shiro:hasPermission name="womanbsctj:delete">
											<a class="btn  b_delete_" href="/womanbsctj/delete/${businessForm.id }"
												><i class="icon-trash"></i>删除</a>
										
										</shiro:hasPermission> <a class="btn " href="/womanbsctj/item/${businessForm.id }"><i class=" icon-folder-open"></i>名单</a>
										<shiro:hasPermission name="womanbsctj:submit">
										<c:if test="${businessForm.processStatus != '书记审核'}">
			<a class="btn b_submit_check" href="/womanbsctj/submit/${businessForm.id}"><i class="icon-upload"></i>提交审核</a>
