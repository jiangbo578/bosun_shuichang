...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"../../file/upload/"             //图片上传提交地址
        ...
        //附件上传配置区
        ,fileUrl:URL+"/file/upload"               //附件上传提交地址
        ,filePath:"/file/upload"                   //附件修正地址，同imagePath
		...
		,
		toolbars : [ [ "fullscreen", "source", "insertimage", "attachment",
				"unlink", "link", "undo", "redo", "inserttable", "deletetable",
				"mergecells", "splittocells", "bold", "italic", "underline",
				"fontborder", "strikethrough", "forecolor", "backcolor",
				"superscript", "subscript", "justifyleft", "justifycenter",
				"justifyright", "justifyjustify", "fontfamily", "fontsize",
				"removeformat", "formatmatch", "autotypeset", "date", "time",
				"map", "pasteplain", "background" ] ]
