...
<body>
  ...
  <i class="icon-list">&nbsp;&nbsp;</i><strong>考核管理添加</strong> 
	...
	<div class="container">
		<form action="/assess/add" method="post">
			...
			<table>
				...
				<tr>
					<th>总分：</th>
					<td><input name="sumScore" type="text" data-rule="required;digits;range[1~100]"  style="width: 200px"/>
					</td>
				</tr>
				<tr>
					<th>可用状态：</th>
					<td>
						<input type="radio" value="true" name="enableFlag" checked="checked">可用
				...
				<tr>
					<th>描述：</th>
					<td><input name="description" data-rule="length[1~150];" type="text" style="width: 200px"/>
					</td>
				</tr>
				<tr>
					<th>&nbsp;</th>
